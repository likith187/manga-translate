...
public abstract class a {
    ...
    protected final androidx.collection.a f3842a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    protected final androidx.collection.a f3843b;

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    protected final androidx.collection.a f3844c;
    ...
    private Class c(Class cls) throws ClassNotFoundException {
        Class cls2 = (Class) this.f3844c.get(cls.getName());
        if (cls2 != null) {
            return cls2;
        }
        Class<?> cls3 = Class.forName(String.format("%s.%sParcelizer", cls.getPackage().getName(), cls.getSimpleName()), false, cls.getClassLoader());
        this.f3844c.put(cls.getName(), cls3);
        return cls3;
    }

    private Method d(String str) throws NoSuchMethodException {
        Method method = (Method) this.f3842a.get(str);
        if (method != null) {
            return method;
        }
        System.currentTimeMillis();
        Method declaredMethod = Class.forName(str, true, a.class.getClassLoader()).getDeclaredMethod("read", a.class);
        this.f3842a.put(str, declaredMethod);
        return declaredMethod;
    }

    private Method e(Class cls) throws NoSuchMethodException, ClassNotFoundException {
        Method method = (Method) this.f3843b.get(cls.getName());
        if (method != null) {
            return method;
        }
        Class clsC = c(cls);
        ...
        this.f3843b.put(cls.getName(), declaredMethod);
        return declaredMethod;
    }
    ...
    protected void K(w0.a aVar, a aVar2) {
        try {
    ...
    public void M(w0.a aVar, int i10) {
        w(i10);
        L(aVar);
    }
    ...
    protected w0.a n(String str, a aVar) {
        try {
            return (w0.a) d(str).invoke(null, aVar);
        } catch (ClassNotFoundException e10) {
            throw new RuntimeException("VersionedParcel encountered ClassNotFoundException", e10);
        } catch (IllegalAccessException e11) {
            throw new RuntimeException("VersionedParcel encountered IllegalAccessException", e11);
    ...
    public w0.a v(w0.a aVar, int i10) {
        return !m(i10) ? aVar : u();
    }
