...
public class ListMenuItemView extends LinearLayout implements MenuView.ItemView, AbsListView.SelectionBoundsAdjuster {
    ...
    public ListMenuItemView(Context context, AttributeSet attributeSet, int i10) {
        ...
        h0 h0VarW = h0.w(getContext(), attributeSet, R$styleable.MenuView, i10, 0);
        this.mBackground = h0VarW.g(R$styleable.MenuView_android_itemBackground);
        this.mTextAppearance = h0VarW.n(R$styleable.MenuView_android_itemTextAppearance, -1);
        this.mPreserveIconSpacing = h0VarW.a(R$styleable.MenuView_preserveIconSpacing, false);
        this.mTextAppearanceContext = context;
        this.mSubMenuArrow = h0VarW.g(R$styleable.MenuView_subMenuArrow);
