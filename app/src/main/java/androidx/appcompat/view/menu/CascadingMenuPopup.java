...
final class CascadingMenuPopup extends MenuPopup implements MenuPresenter, View.OnKeyListener, PopupWindow.OnDismissListener {
    ...
    private MenuPopupWindow createPopupWindow() {
        ...
        menuPopupWindow.Q(this.mMenuItemHoverListener);
        menuPopupWindow.H(this);
        menuPopupWindow.G(this);
        menuPopupWindow.y(this.mAnchorView);
        menuPopupWindow.B(this.mDropDownGravity);
    ...
    private void showMenu(MenuBuilder menuBuilder) {
        ...
        menuPopupWindowCreatePopupWindow.k(menuAdapter);
        menuPopupWindowCreatePopupWindow.A(iMeasureIndividualMenuWidth);
        menuPopupWindowCreatePopupWindow.B(this.mDropDownGravity);
        ...
        if (viewFindParentViewForSubmenu != null) {
            menuPopupWindowCreatePopupWindow.R(false);
            menuPopupWindowCreatePopupWindow.O(null);
            int nextMenuPosition = getNextMenuPosition(iMeasureIndividualMenuWidth);
            boolean z10 = nextMenuPosition == 1;
            this.mLastPosition = nextMenuPosition;
            menuPopupWindowCreatePopupWindow.y(viewFindParentViewForSubmenu);
            ...
            menuPopupWindowCreatePopupWindow.g(iMeasureIndividualMenuWidth);
            menuPopupWindowCreatePopupWindow.J(true);
            menuPopupWindowCreatePopupWindow.e(0);
        } else {
            if (this.mHasXOffset) {
                menuPopupWindowCreatePopupWindow.g(this.mXOffset);
            }
            if (this.mHasYOffset) {
                menuPopupWindowCreatePopupWindow.e(this.mYOffset);
            }
            menuPopupWindowCreatePopupWindow.C(getEpicenterBounds());
        }
    ...
    public void onCloseMenu(MenuBuilder menuBuilder, boolean z10) {
        ...
        if (this.mShouldCloseImmediately) {
            cascadingMenuInfoRemove.window.P(null);
            cascadingMenuInfoRemove.window.z(0);
        }
    ...
    public void setAnchorView(View view) {
        if (this.mAnchorView != view) {
            this.mAnchorView = view;
            this.mDropDownGravity = j.b(this.mRawDropDownGravity, view.getLayoutDirection());
        }
    }
    ...
    public void setGravity(int i10) {
        if (this.mRawDropDownGravity != i10) {
            ...
            this.mDropDownGravity = j.b(i10, this.mAnchorView.getLayoutDirection());
        }
    }
