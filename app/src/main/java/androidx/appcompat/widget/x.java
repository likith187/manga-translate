...
public abstract class x implements View.OnTouchListener, View.OnAttachStateChangeListener {
    ...
    private boolean b(MotionEvent motionEvent) {
        ...
        e(view, motionEventObtainNoHistory);
        f(vVar, motionEventObtainNoHistory);
        boolean zE = vVar.e(motionEventObtainNoHistory, this.mActivePointerId);
    ...
    */
    private boolean c(android.view.MotionEvent r6) {
        ...
        L6d:
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.appcompat.widget.x.c(android.view.MotionEvent):boolean");
    }

    private static boolean d(View view, float f10, float f11, float f12) {
        float f13 = -f12;
    ...
    public boolean onTouch(View view, MotionEvent motionEvent) {
        ...
        if (z11) {
            z10 = b(motionEvent) || !onForwardingStopped();
        } else {
            z10 = c(motionEvent) && onForwardingStarted();
            if (z10) {
                long jUptimeMillis = SystemClock.uptimeMillis();
                MotionEvent motionEventObtain = MotionEvent.obtain(jUptimeMillis, jUptimeMillis, 3, 0.0f, 0.0f, 0);
