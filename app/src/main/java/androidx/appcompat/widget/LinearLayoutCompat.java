...
public class LinearLayoutCompat extends ViewGroup {
    ...
    */
    ...
    public LinearLayoutCompat(Context context, AttributeSet attributeSet, int i10) {
        ...
        h0 h0VarW = h0.w(context, attributeSet, R$styleable.LinearLayoutCompat, i10, 0);
        androidx.core.view.m0.h0(this, context, R$styleable.LinearLayoutCompat, attributeSet, h0VarW.r(), i10, 0);
        int iK = h0VarW.k(R$styleable.LinearLayoutCompat_android_orientation, -1);
        if (iK >= 0) {
            setOrientation(iK);
        }
        int iK2 = h0VarW.k(R$styleable.LinearLayoutCompat_android_gravity, -1);
        if (iK2 >= 0) {
            setGravity(iK2);
        }
        boolean zA = h0VarW.a(R$styleable.LinearLayoutCompat_android_baselineAligned, true);
        if (!zA) {
            setBaselineAligned(zA);
        }
        this.mWeightSum = h0VarW.i(R$styleable.LinearLayoutCompat_android_weightSum, -1.0f);
        this.mBaselineAlignedChildIndex = h0VarW.k(R$styleable.LinearLayoutCompat_android_baselineAlignedChildIndex, -1);
        this.mUseLargestChild = h0VarW.a(R$styleable.LinearLayoutCompat_measureWithLargestChild, false);
        setDividerDrawable(h0VarW.g(R$styleable.LinearLayoutCompat_divider));
        this.mShowDividers = h0VarW.k(R$styleable.LinearLayoutCompat_showDividers, 0);
        this.mDividerPadding = h0VarW.f(R$styleable.LinearLayoutCompat_dividerPadding, 0);
        h0VarW.y();
    }
