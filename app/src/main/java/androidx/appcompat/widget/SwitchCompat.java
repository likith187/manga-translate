...
public class SwitchCompat extends CompoundButton {
    ...
    static class b extends e.f {
        ...
        private final Reference f792a;

        b(SwitchCompat switchCompat) {
            this.f792a = new WeakReference(switchCompat);
        }

        @Override // androidx.emoji2.text.e.f
        public void a(Throwable th) {
            SwitchCompat switchCompat = (SwitchCompat) this.f792a.get();
        ...
        if (drawable != null) {
            if (this.mHasThumbTint || this.mHasThumbTintMode) {
                ...
                if (this.mHasThumbTint) {
                    v.a.o(drawableMutate, this.mThumbTintList);
                }
                if (this.mHasThumbTintMode) {
                    v.a.p(this.mThumbDrawable, this.mThumbTintMode);
                }
        ...
        if (drawable != null) {
            if (this.mHasTrackTint || this.mHasTrackTintMode) {
                ...
                if (this.mHasTrackTint) {
                    v.a.o(drawableMutate, this.mTrackTintList);
                }
                if (this.mHasTrackTintMode) {
                    v.a.p(this.mTrackDrawable, this.mTrackTintMode);
                }
    ...
    private int getThumbOffset() {
        return (int) (((o0.b(this) ? 1.0f - this.mThumbPosition : this.mThumbPosition) * getThumbScrollRange()) + 0.5f);
    }
    ...
    private int getThumbScrollRange() {
        ...
        Rect rectC = drawable2 != null ? u.c(drawable2) : u.f980c;
        return ((((this.mSwitchWidth - this.mThumbWidth) - rect.left) - rect.right) - rectC.left) - rectC.right;
    }
    ...
    private void j() {
        ...
        androidx.core.view.m0.C0(this, string);
    }
    ...
    public void draw(Canvas canvas) {
        ...
        Drawable drawable = this.mThumbDrawable;
        Rect rectC = drawable != null ? u.c(drawable) : u.f980c;
        ...
        if (drawable3 != null) {
            ...
            if (background != null) {
                v.a.l(background, i24, i13, i25, i15);
            }
        }
        super.draw(canvas);
    }
    ...
    protected void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        if (this.mThumbDrawable != null) {
            ...
            Rect rectC = u.c(this.mThumbDrawable);
    ...
    */
    ...
    public void setSwitchTextAppearance(Context context, int i10) {
        ...
        ColorStateList colorStateListC = h0VarU.c(R$styleable.TextAppearance_android_textColor);
        if (colorStateListC != null) {
            this.mTextColors = colorStateListC;
        } else {
            this.mTextColors = getTextColors();
        }
        int iF = h0VarU.f(R$styleable.TextAppearance_android_textSize, 0);
        if (iF != 0) {
            float f10 = iF;
        ...
        l(h0VarU.k(R$styleable.TextAppearance_android_typeface, -1), h0VarU.k(R$styleable.TextAppearance_android_textStyle, -1));
        if (h0VarU.a(R$styleable.TextAppearance_textAllCaps, false)) {
    ...
    public SwitchCompat(Context context, AttributeSet attributeSet, int i10) {
        ...
        h0 h0VarW = h0.w(context, attributeSet, R$styleable.SwitchCompat, i10, 0);
        androidx.core.view.m0.h0(this, context, R$styleable.SwitchCompat, attributeSet, h0VarW.r(), i10, 0);
        Drawable drawableG = h0VarW.g(R$styleable.SwitchCompat_android_thumb);
        this.mThumbDrawable = drawableG;
        if (drawableG != null) {
            drawableG.setCallback(this);
        }
        Drawable drawableG2 = h0VarW.g(R$styleable.SwitchCompat_track);
        this.mTrackDrawable = drawableG2;
        if (drawableG2 != null) {
            drawableG2.setCallback(this);
        }
        setTextOnInternal(h0VarW.p(R$styleable.SwitchCompat_android_textOn));
        setTextOffInternal(h0VarW.p(R$styleable.SwitchCompat_android_textOff));
        this.mShowText = h0VarW.a(R$styleable.SwitchCompat_showText, true);
        this.mThumbTextPadding = h0VarW.f(R$styleable.SwitchCompat_thumbTextPadding, 0);
        this.mSwitchMinWidth = h0VarW.f(R$styleable.SwitchCompat_switchMinWidth, 0);
        this.mSwitchPadding = h0VarW.f(R$styleable.SwitchCompat_switchPadding, 0);
        this.mSplitTrack = h0VarW.a(R$styleable.SwitchCompat_splitTrack, false);
        ColorStateList colorStateListC = h0VarW.c(R$styleable.SwitchCompat_thumbTint);
        if (colorStateListC != null) {
            this.mThumbTintList = colorStateListC;
            this.mHasThumbTint = true;
        }
        PorterDuff.Mode modeD = u.d(h0VarW.k(R$styleable.SwitchCompat_thumbTintMode, -1), null);
        if (this.mThumbTintMode != modeD) {
            this.mThumbTintMode = modeD;
            this.mHasThumbTintMode = true;
        }
        if (this.mHasThumbTint || this.mHasThumbTintMode) {
            b();
        }
        ColorStateList colorStateListC2 = h0VarW.c(R$styleable.SwitchCompat_trackTint);
        if (colorStateListC2 != null) {
            this.mTrackTintList = colorStateListC2;
            this.mHasTrackTint = true;
        }
        PorterDuff.Mode modeD2 = u.d(h0VarW.k(R$styleable.SwitchCompat_trackTintMode, -1), null);
        if (this.mTrackTintMode != modeD2) {
            this.mTrackTintMode = modeD2;
            this.mHasTrackTintMode = true;
        }
        if (this.mHasTrackTint || this.mHasTrackTintMode) {
            c();
        }
        int iN = h0VarW.n(R$styleable.SwitchCompat_switchTextAppearance, 0);
        if (iN != 0) {
