...
public class FileProvider extends ContentProvider {
    ...
    private static final String[] f1986h = {"_display_name", "_size"};

    /* JADX INFO: renamed from: i, reason: collision with root package name */
    private static final File f1987i = new File("/");

    /* JADX INFO: renamed from: j, reason: collision with root package name */
    private static final HashMap f1988j = new HashMap();
    ...
    static class c implements b {
        ...
        public File a(Uri uri) {
            ...
            File file = (File) this.f1994b.get(strDecode);
            if (file == null) {
        ...
        public Uri b(File file) {
            try {
                ...
                for (Map.Entry entry2 : this.f1994b.entrySet()) {
                ...
                return new Uri.Builder().scheme(TranslationClient.PARAM_KEY_CONTENT).authority(this.f1993a).encodedPath(Uri.encode((String) entry.getKey()) + '/' + Uri.encode(path2.endsWith("/") ? canonicalPath.substring(path2.length()) : canonicalPath.substring(path2.length() + 1), "/")).build();
            } catch (IOException unused) {
        ...
        void c(String str, File file) {
            ...
            try {
                this.f1994b.put(str, file.getCanonicalFile());
    ...
    private b f() {
        ...
        synchronized (this.f1989a) {
            try {
                c0.c.d(this.f1991c, "mAuthority is null. Did you override attachInfo and did not call super.attachInfo()?");
                if (this.f1992f == null) {
                    this.f1992f = g(getContext(), this.f1991c, this.f1990b);
                }
                bVar = this.f1992f;
            } catch (Throwable th) {
                throw th;
    ...
    private static b j(Context context, String str, int i10) throws XmlPullParserException, IOException {
        ...
        while (true) {
            ...
            if (next == 2) {
                ...
                String attributeValue2 = xmlResourceParserE.getAttributeValue(null, Constants.MessagerConstants.PATH_KEY);
                if ("root-path".equals(name)) {
                    externalStorageDirectory = f1987i;
    ...
    public void attachInfo(Context context, ProviderInfo providerInfo) {
        ...
        String str2 = providerInfo.authority.split(Constants.DataMigration.SPLIT_TAG)[0];
        synchronized (this.f1989a) {
            this.f1991c = str2;
        }
        HashMap map = f1988j;
