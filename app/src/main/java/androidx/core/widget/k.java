...
public final class k {
    private static CharSequence a(Context context, ClipData.Item item, int i10) {
        if ((i10 & 1) == 0) {
    ...
    public androidx.core.view.c b(View view, androidx.core.view.c cVar) {
        ...
        for (int i10 = 0; i10 < clipDataA.getItemCount(); i10++) {
            CharSequence charSequenceA = a(context, clipDataA.getItemAt(i10), iB);
            if (charSequenceA != null) {
                if (z10) {
                    editable.insert(Selection.getSelectionEnd(editable), "\n");
                    editable.insert(Selection.getSelectionEnd(editable), charSequenceA);
                } else {
                    c(editable, charSequenceA);
                    z10 = true;
                }
            }
        }
