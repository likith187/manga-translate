...
public abstract class j {
    ...
    private static final ThreadLocal f15424a = new a();

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private static final ThreadLocal f15425b = new b();

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    private static final ThreadLocal f15426c = new c();

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    private static final ThreadLocal f15427d = new d();

    /* JADX INFO: renamed from: e, reason: collision with root package name */
    private static final float f15428e = (float) (Math.sqrt(2.0d) / 2.0d);
    ...
    public static void a(Path path, float f10, float f11, float f12) {
        ...
        PathMeasure pathMeasure = (PathMeasure) f15424a.get();
        Path path2 = (Path) f15425b.get();
        Path path3 = (Path) f15426c.get();
    ...
    public static void b(Path path, u uVar) {
        ...
        a(path, ((j1.d) uVar.j()).q() / 100.0f, ((j1.d) uVar.g()).q() / 100.0f, ((j1.d) uVar.h()).q() / 360.0f);
    }
