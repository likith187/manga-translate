...
public abstract class a {
    private static final boolean a(String str) {
        ...
        for (int i10 = 0; i10 < length; i10++) {
            ...
            if (r.f(cCharAt, 31) <= 0 || r.f(cCharAt, ErrorCode.CODE_SERVICE_DIED) >= 0 || kotlin.text.r.V(" #%/:?@[\\]", cCharAt, 0, false, 6, null) != -1) {
                return true;
            }
        }
        return false;
    ...
    private static final boolean b(String str, int i10, int i11, byte[] bArr, int i12) {
        ...
        while (i10 < i11) {
            ...
            while (i14 < i11) {
                ...
                if (r.f(cCharAt, 48) < 0 || r.f(cCharAt, 57) > 0) {
                    break;
                }
    ...
    */
    private static final java.net.InetAddress c(java.lang.String r18, int r19, int r20) {
        ...
        L15:
            ...
            r10 = r5
            r5 = r17
            boolean r0 = kotlin.text.r.E(r0, r1, r2, r3, r4, r5)
            if (r0 == 0) goto L38
            if (r14 == r11) goto L2e
            return r16
        L2e:
        ...
        La8:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: i9.a.c(java.lang.String, int, int):java.net.InetAddress");
    }
    ...
    private static final String d(byte[] bArr) {
        ...
        while (i11 < bArr.length) {
            if (i11 == i10) {
                ...
                dVar.s((d.d(bArr[i11], 255) << 8) | d.d(bArr[i11 + 1], 255));
                i11 += 2;
            }
        }
        return dVar.D0();
    ...
    public static final String e(String str) {
        r.e(str, "<this>");
        if (!kotlin.text.r.K(str, ":", false, 2, null)) {
            try {
                String ascii = IDN.toASCII(str);
                r.d(ascii, "toASCII(host)");
                Locale US = Locale.US;
                r.d(US, "US");
        ...
        InetAddress inetAddressC = (kotlin.text.r.F(str, "[", false, 2, null) && kotlin.text.r.u(str, "]", false, 2, null)) ? c(str, 1, str.length() - 1) : c(str, 0, str.length());
