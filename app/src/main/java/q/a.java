...
public abstract class a {
    ...
    static /* synthetic */ class C0205a {
        ...
        static {
            ...
            f15252a = iArr;
            try {
                iArr[a.EnumC0009a.INT_TYPE.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                f15252a[a.EnumC0009a.FLOAT_TYPE.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f15252a[a.EnumC0009a.COLOR_DRAWABLE_TYPE.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f15252a[a.EnumC0009a.COLOR_TYPE.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f15252a[a.EnumC0009a.STRING_TYPE.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f15252a[a.EnumC0009a.BOOLEAN_TYPE.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f15252a[a.EnumC0009a.DIMENSION_TYPE.ordinal()] = 7;
    ...
    public static void b(androidx.constraintlayout.widget.a aVar, View view, float[] fArr) {
        ...
        try {
            boolean z10 = true;
            switch (C0205a.f15252a[aVar.d().ordinal()]) {
                case 1:
