...
public abstract class a {
    ...
    private static final byte[] f15727a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private static final byte[] f15728b;

    static {
        g.a aVar = g.Companion;
        f15727a = aVar.d("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/").getData$okio();
        f15728b = aVar.d("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-_").getData$okio();
    }
    ...
    public static final byte[] a(String str) {
        ...
        kotlin.jvm.internal.r.d(bArrCopyOf, "copyOf(this, newSize)");
        return bArrCopyOf;
    }
