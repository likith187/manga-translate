...
public abstract class h {
    ...
    private static final ThreadLocal f13623a = new a();

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private static final ThreadLocal f13624b = new b();

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    private static final ThreadLocal f13625c = new c();

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    private static final ThreadLocal f13626d = new d();

    /* JADX INFO: renamed from: e, reason: collision with root package name */
    private static final float f13627e = (float) (Math.sqrt(2.0d) / 2.0d);
    ...
    public static void a(Path path, float f10, float f11, float f12) {
        k0.a("applyTrimPathIfNeeded");
        PathMeasure pathMeasure = (PathMeasure) f13623a.get();
        Path path2 = (Path) f13624b.get();
        Path path3 = (Path) f13625c.get();
        pathMeasure.setPath(path, false);
        float length = pathMeasure.getLength();
        if (f10 == 1.0f && f11 == 0.0f) {
            k0.b("applyTrimPathIfNeeded");
            return;
        }
        ...
        if (fMin >= length && fMax >= length) {
            fMin = g.f(fMin, length);
            fMax = g.f(fMax, length);
        }
        if (fMin < 0.0f) {
            fMin = g.f(fMin, length);
        }
    ...
    public static void b(Path path, u uVar) {
        ...
        a(path, ((d6.d) uVar.j()).p() / 100.0f, ((d6.d) uVar.h()).p() / 100.0f, ((d6.d) uVar.i()).p() / 360.0f);
    }
    ...
    public static void o(Canvas canvas, RectF rectF, Paint paint, int i10) {
        k0.a("Utils#saveLayer");
        canvas.saveLayer(rectF, paint);
        k0.b("Utils#saveLayer");
    }
}
