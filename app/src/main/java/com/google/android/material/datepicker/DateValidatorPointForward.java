...
public class DateValidatorPointForward implements CalendarConstraints.DateValidator {
    ...
    public boolean equals(Object obj) {
        ...
        return (obj instanceof DateValidatorPointForward) && this.f9390a == ((DateValidatorPointForward) obj).f9390a;
    }

    public int hashCode() {
        return Arrays.hashCode(new Object[]{Long.valueOf(this.f9390a)});
    }

    @Override // android.os.Parcelable
    public void writeToParcel(Parcel parcel, int i10) {
        parcel.writeLong(this.f9390a);
    }
