...
class ViewUtilsLollipop {
    ...
    static void setDefaultAppBarLayoutStateListAnimator(View view, float f10) {
    ...
    static void setStateListAnimatorFromAttrs(View view, AttributeSet attributeSet, int i10, int i11) {
