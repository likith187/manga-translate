...
public class RangeSlider extends BaseSlider<RangeSlider, Object, Object> {
    ...
    static class RangeSliderState extends AbsSavedState {
        ...
        public void writeToParcel(Parcel parcel, int i10) {
            ...
            parcel.writeFloat(this.f10249a);
    ...
    protected void onRestoreInstanceState(Parcelable parcelable) {
        ...
        this.E0 = rangeSliderState.f10249a;
        int i10 = rangeSliderState.f10250b;
        this.F0 = i10;
    ...
    public Parcelable onSaveInstanceState() {
        ...
        rangeSliderState.f10249a = this.E0;
        rangeSliderState.f10250b = this.F0;
    ...
    public RangeSlider(Context context, AttributeSet attributeSet, int i10) {
        ...
        TypedArray typedArrayObtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context, attributeSet, R$styleable.RangeSlider, i10, BaseSlider.f10189z0, new int[0]);
        if (typedArrayObtainStyledAttributes.hasValue(R$styleable.RangeSlider_values)) {
            setValues(G0(typedArrayObtainStyledAttributes.getResources().obtainTypedArray(typedArrayObtainStyledAttributes.getResourceId(R$styleable.RangeSlider_values, 0))));
        }
        this.E0 = typedArrayObtainStyledAttributes.getDimension(R$styleable.RangeSlider_minSeparation, 0.0f);
