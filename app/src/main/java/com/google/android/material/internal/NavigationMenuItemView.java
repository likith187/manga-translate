...
public class NavigationMenuItemView extends ForegroundLinearLayout implements MenuView.ItemView {
    ...
    public void initialize(MenuItemImpl menuItemImpl, int i10) {
        ...
        if (getBackground() == null) {
            m0.n0(this, createDefaultBackground());
        }
        ...
        androidx.appcompat.widget.m0.a(this, menuItemImpl.getTooltipText());
        adjustAppearance();
    }
    ...
    public void setCheckable(boolean z10) {
        ...
        if (this.checkable != z10) {
            this.checkable = z10;
            this.accessibilityDelegate.sendAccessibilityEvent(this.textView, ConfigPackage.FRAME_SIZE_3);
        }
    }
    ...
    public void setChecked(boolean z10) {
        ...
        checkedTextView.setTypeface(checkedTextView.getTypeface(), (z10 && this.isBold) ? 1 : 0);
    }
    ...
    public void setIcon(Drawable drawable) {
        if (drawable != null) {
            if (this.hasIconTintList) {
                ...
                v.a.o(drawable, this.iconTintList);
            }
            int i10 = this.iconSize;
            drawable.setBounds(0, 0, i10, i10);
        } else if (this.needsEmptyIcon) {
            if (this.emptyDrawable == null) {
                Drawable drawableF = h.f(getResources(), R$drawable.navigation_empty_icon, getContext().getTheme());
                this.emptyDrawable = drawableF;
                if (drawableF != null) {
        ...
        j.i(this.textView, drawable, null, null, null);
    }
    ...
    public NavigationMenuItemView(Context context, AttributeSet attributeSet, int i10) {
        ...
        androidx.core.view.a aVar = new androidx.core.view.a() { // from class: com.google.android.material.internal.NavigationMenuItemView.1
            ...
            public void onInitializeAccessibilityNodeInfo(View view, d0.h hVar) {
                ...
                hVar.f0(NavigationMenuItemView.this.checkable);
            }
        };
