...
abstract class HeaderBehavior<V extends View> extends ViewOffsetBehavior<V> {
    ...
    public boolean onInterceptTouchEvent(CoordinatorLayout coordinatorLayout, V v10, MotionEvent motionEvent) {
        ...
        if (motionEvent.getActionMasked() == 0) {
            ...
            boolean z10 = canDragView(v10) && coordinatorLayout.z(v10, x10, y11);
    ...
    */
    ...
    int setHeaderTopBottomOffset(CoordinatorLayout coordinatorLayout, V v10, int i10, int i11, int i12) {
        ...
        if (i11 == 0 || topAndBottomOffset < i11 || topAndBottomOffset > i12 || topAndBottomOffset == (iB = x.a.b(i10, i11, i12))) {
            return 0;
        }
