...
public abstract class i extends f implements List, RandomAccess {
    private static final l zba = new g(j.zba, 0);

    i() {
    }

    public static i zbg(Object obj) {
        Object[] objArr = {obj};
        if (obj != null) {
    ...
    @Override // com.google.android.gms.internal.mlkit_language_id_bundled.f, java.util.AbstractCollection, java.util.Collection, java.lang.Iterable
    ...
    public i subList(int i10, int i11) {
        c.c(i10, i11, size());
        int i12 = i11 - i10;
        return i12 == size() ? this : i12 == 0 ? j.zba : new h(this, i10, i12);
    }
    ...
    public final l listIterator(int i10) {
        c.b(i10, size(), "index");
        return isEmpty() ? zba : new g(this, i10);
    }
}
