...
public enum g7 implements l {
    ...
    ON_DEVICE_IMAGE_LABEL_DETECT(AIProtocol.PROTOCOL_VERSION_RECORD_SUMMARY),
    ON_DEVICE_IMAGE_LABEL_CREATE(142),
    ON_DEVICE_IMAGE_LABEL_CLOSE(AIProtocol.PROTOCOL_TEL_AI),
    ON_DEVICE_IMAGE_LABEL_LOAD(144),
    ON_DEVICE_SMART_REPLY_DETECT(151),
    ON_DEVICE_SMART_REPLY_CREATE(VibrateUtils.TYPE_STEPABLE_REGULATE),
    ON_DEVICE_SMART_REPLY_CLOSE(153),
    ON_DEVICE_SMART_REPLY_BLACKLIST_UPDATE(VibrateUtils.TYPE_STEPABLE_EDGE),
    ...
    CUSTOM_IMAGE_LABEL_LOAD(ModuleType.TYPE_LAUNCHER),
    ...
    CLOUD_WEB_SEARCH_CREATE(AIProtocol.PROTOCOL_VERSION_AIGC_LOCAL),
    CLOUD_WEB_SEARCH_DETECT(AIProtocol.PROTOCOL_VERSION_AIGC_SUMMARY_LOCAL),
    CLOUD_WEB_SEARCH_CLOSE(AIProtocol.PROTOCOL_VERSION_AIGC_EXP),
    ...
    AGGREGATED_CUSTOM_MODEL_INFERENCE(b5.a.CODE_SCANNER_CANCELLED),
    AGGREGATED_ON_DEVICE_BARCODE_DETECTION(b5.a.CODE_SCANNER_CAMERA_PERMISSION_NOT_GRANTED),
    AGGREGATED_ON_DEVICE_FACE_DETECTION(203),
    AGGREGATED_ON_DEVICE_IMAGE_LABEL_DETECTION(b5.a.CODE_SCANNER_TASK_IN_PROGRESS),
    AGGREGATED_ON_DEVICE_OBJECT_INFERENCE(b5.a.CODE_SCANNER_PIPELINE_INITIALIZATION_ERROR),
    AGGREGATED_ON_DEVICE_TEXT_DETECTION(b5.a.CODE_SCANNER_PIPELINE_INFERENCE_ERROR),
    AGGREGATED_ON_DEVICE_POSE_DETECTION(b5.a.CODE_SCANNER_GOOGLE_PLAY_SERVICES_VERSION_TOO_OLD),
    ...
    REMOTE_CONFIG_ACTIVATE(ModuleType.TYPE_CALLRECORD),
    ...
    INSTALLATION_ID_FIS_GENERATE_AUTH_TOKEN(COUIHapticFeedbackConstants.GRANULAR_SHORT_VIBRATE),
    ...
    ON_DEVICE_SELFIE_FACE_LOAD(ConfigPackage.FRAME_SIZE_1),
