...
public abstract class nb extends jb implements List, RandomAccess {
    private static final h zza = new lb(rb.zza, 0);

    nb() {
    }

    static nb zzg(Object[] objArr) {
        return zzh(objArr, objArr.length);
    }

    static nb zzh(Object[] objArr, int i10) {
        return i10 == 0 ? rb.zza : new rb(objArr, i10);
    }

    public static nb zzi(Object obj, Object obj2) {
    ...
    public final boolean equals(@CheckForNull Object obj) {
        ...
        if (obj instanceof List) {
            ...
            if (size == list.size()) {
                ...
                while (true) {
                    if (it.hasNext()) {
                        if (!it2.hasNext() || !g5.a(it.next(), it2.next())) {
                            break;
                        }
                    } else if (!it2.hasNext()) {
                        return true;
    ...
    public nb subList(int i10, int i11) {
        i9.c(i10, i11, size());
        int i12 = i11 - i10;
        return i12 == size() ? this : i12 == 0 ? rb.zza : new mb(this, i10, i12);
    }
    ...
    public final h listIterator(int i10) {
        i9.b(i10, size(), "index");
        return isEmpty() ? zza : new lb(this, i10);
    }
}
