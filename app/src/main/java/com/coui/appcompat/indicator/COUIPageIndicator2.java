...
public class COUIPageIndicator2 extends View implements COUIIPagerIndicator {
    ...
    private class PageIndicatorModel {
        ...
        private final d mCurrentPosition = new d("currentPosition") { // from class: com.coui.appcompat.indicator.COUIPageIndicator2.PageIndicatorModel.1
        ...
        PageIndicatorModel(View view) {
            this.mViewHost = view;
            this.mScaleMaskIndex = new float[]{0.0f, f, f, f - ((COUIPageIndicator2.INDICATOR_DOT_GONE_LEVEL_SIZE - fArr[2]) / 2.0f)};
            ...
            for (PageIndicatorDotModel pageIndicatorDotModel : this.mDots) {
                ...
                if (this.mCurrentOffset == 0.0f || (iIndexOf != (i10 = this.mCurrentIndex) && iIndexOf - 1 != i10)) {
                    ...
                    if (f12 >= fArr[0] && f10 - f11 <= fArr[1]) {
                        COUILog.d(COUIPageIndicator2.DEBUG, COUIPageIndicator2.TAG, "drawDots: dot index = " + iIndexOf + " dot radius = " + pageIndicatorDotModel.mRadius + " dot location = (" + pageIndicatorDotModel.mCenterX + ", " + pageIndicatorDotModel.mCenterY + ") left = " + this.mVisibleBounds[0] + " right = " + this.mVisibleBounds[1]);
        ...
        */
        ...
        private void updatePath() {
            ...
            COUILog.d(COUIPageIndicator2.DEBUG, COUIPageIndicator2.TAG, "updatePath: mCurrentOffset = " + this.mCurrentOffset + " dots size = " + this.mDots.size() + " startDot = (" + centerX + ", " + centerY + ", " + radius + ") endDot = (" + centerX2 + ", " + centerY2 + ", " + radius2 + ") colorFactor = " + colorFactor + " moveFactor = " + moveFactor + " mDepartOffset = " + f11 + " mPortOffset = " + f18 + ") control1 = (" + f15 + ", " + fSqrt + ") control2 = (" + f19 + ", " + f20 + ") control3 = (" + f17 + ", " + fSqrt2 + ") snapAngle = " + fAsin);
            this.mPath.reset();
            ...
            float f27 = f21 + f11;
            float f28 = f25 + f11;
            this.mPathUp.arcTo(f27, f24, f28, f26, COUIPageIndicator2.ONE_AND_A_HALF_OF_PI_IN_DEGREE, fAsin, false);
            ...
            this.mPathUp.arcTo(f30, f31, f32, f33, COUIPageIndicator2.ONE_AND_A_HALF_OF_PI_IN_DEGREE - fAsin, fAsin, false);
            ...
            this.mPathDown.arcTo(f30, f31, f32, f33, COUIPageIndicator2.HALF_OF_PI_IN_DEGREE, fAsin, false);
            this.mPathDown.quadTo(f19, (centerY2 * 2.0f) - f20, f15, (centerY * 2.0f) - fSqrt);
            this.mPathDown.arcTo(f27, f24, f28, f26, COUIPageIndicator2.HALF_OF_PI_IN_DEGREE - fAsin, fAsin, false);
    ...
    public COUIPageIndicator2(Context context, AttributeSet attributeSet, int i10, int i11) {
        ...
        if (attributeSet != null) {
            TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, R$styleable.COUIPageIndicator2, i10, i11);
            this.mTraceColor = typedArrayObtainStyledAttributes.getColor(R$styleable.COUIPageIndicator2_traceDotColor, 0);
            this.mDotColor = typedArrayObtainStyledAttributes.getColor(R$styleable.COUIPageIndicator2_dotColor, 0);
