...
public class COUIEditTextPreference extends EditTextPreference implements COUICardSupportInterface, COUIRecyclerView.b {
    ...
    public COUIEditTextPreference(Context context, AttributeSet attributeSet) {
        ...
        TypedArray typedArrayObtainStyledAttributes2 = context.obtainStyledAttributes(attributeSet, R$styleable.couiEditTextPreference, 0, 0);
        this.mSupportEmptyInput = typedArrayObtainStyledAttributes2.getBoolean(R$styleable.couiEditTextPreference_couiSupportEmptyInput, false);
