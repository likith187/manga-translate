...
public class COUISwitchWithDividerPreference extends COUISwitchPreference {
    ...
    private void initPreciseHelper() {
        ...
        PreciseClickHelper preciseClickHelper = new PreciseClickHelper(this.mMainLayout, new PreciseClickHelper.OnPreciseClickListener() { // from class: com.coui.appcompat.preference.COUISwitchWithDividerPreference.3
            ...
            public void onClick(View view, int i10, int i11) {
                COUISwitchWithDividerPreference.this.mPreciseListener.onClick(view, i10, i11);
                if (COUISwitchWithDividerPreference.this.mMainLayout == null || COUISwitchWithDividerPreference.this.mClickListener == null) {
                    return;
                }
    ...
    public void onBindViewHolder(l lVar) {
        ...
        if (linearLayout2 != null) {
            if (this.mPreciseListener == null) {
                linearLayout2.setOnClickListener(new View.OnClickListener() { // from class: com.coui.appcompat.preference.COUISwitchWithDividerPreference.1
        ...
        LinearLayout linearLayout3 = (LinearLayout) lVar.itemView.findViewById(R$id.switch_layout);
        this.mSwitchLayout = linearLayout3;
        if (linearLayout3 != null) {
            linearLayout3.setOnClickListener(new View.OnClickListener() { // from class: com.coui.appcompat.preference.COUISwitchWithDividerPreference.2
                @Override // android.view.View.OnClickListener
                public void onClick(View view2) {
    ...
    public void removePreciseClickListener() {
        ...
        if (linearLayout != null) {
            linearLayout.setOnClickListener(new View.OnClickListener() { // from class: com.coui.appcompat.preference.COUISwitchWithDividerPreference.4
                @Override // android.view.View.OnClickListener
