...
public class COUIPercentWidthConstraintLayout extends ConstraintLayout {
    ...
    private void initAttr(AttributeSet attributeSet) {
        if (getContext() != null) {
            ...
            this.mGridNumberResourceId = typedArrayObtainStyledAttributes.getResourceId(R$styleable.COUIPercentWidthConstraintLayout_gridNumber, 0);
            this.mGridNumber = typedArrayObtainStyledAttributes.getInteger(R$styleable.COUIPercentWidthConstraintLayout_gridNumber, getContext().getResources().getInteger(R$integer.grid_guide_column_preference));
