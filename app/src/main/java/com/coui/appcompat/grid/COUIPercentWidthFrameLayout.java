...
public class COUIPercentWidthFrameLayout extends FrameLayout {
    ...
    private void initAttr(AttributeSet attributeSet) {
        if (getContext() != null) {
            ...
            this.mGridNumberResourceId = typedArrayObtainStyledAttributes.getResourceId(R$styleable.COUIPercentWidthFrameLayout_gridNumber, 0);
            this.mGridNumber = typedArrayObtainStyledAttributes.getInteger(R$styleable.COUIPercentWidthFrameLayout_gridNumber, getContext().getResources().getInteger(R$integer.grid_guide_column_preference));
