...
public class COUIPercentWidthLinearLayout extends LinearLayout {
    ...
    private void initAttr(AttributeSet attributeSet) {
        if (getContext() != null) {
            ...
            this.mGridNumberResourceId = typedArrayObtainStyledAttributes.getResourceId(R$styleable.COUIPercentWidthLinearLayout_gridNumber, 0);
            this.mGridNumber = typedArrayObtainStyledAttributes.getInteger(R$styleable.COUIPercentWidthLinearLayout_gridNumber, getContext().getResources().getInteger(R$integer.grid_guide_column_preference));
