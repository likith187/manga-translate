...
public class COUICardListSelectedItemLayout extends ListSelectedItemLayout {
    ...
    private void setPadding(int i10) {
        ...
        View view = this.mMainLayoutToSetExtraPadding;
        if (view != null) {
            view.setPaddingRelative(view.getPaddingStart(), getPaddingTop() + i, this.mMainLayoutToSetExtraPadding.getPaddingEnd(), getPaddingBottom() + i11);
        } else {
    ...
    private void updatePath() {
        ...
        boolean z12 = this.mTopRounded;
        fArr[0] = z12 ? this.mRadius : 0.0f;
        fArr[1] = z12 ? this.mRadius : 0.0f;
        fArr[2] = z12 ? this.mRadius : 0.0f;
        fArr[3] = z12 ? this.mRadius : 0.0f;
        boolean z13 = this.mBottomRounded;
        fArr[4] = z13 ? this.mRadius : 0.0f;
        fArr[5] = z13 ? this.mRadius : 0.0f;
        fArr[6] = z13 ? this.mRadius : 0.0f;
        fArr[7] = z13 ? this.mRadius : 0.0f;
        this.mOplusPathAdapter.addSmoothRoundRect(this.mCardRect, fArr, Path.Direction.CCW);
    }
    ...
    public void setMainLayoutToSetExtraPadding(View view) {
        this.mMainLayoutToSetExtraPadding = view;
    }
    ...
    public COUICardListSelectedItemLayout(Context context, AttributeSet attributeSet, int i10, int i11) {
        ...
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, R$styleable.COUICardListSelectedItemLayout, i10, i11);
        boolean z10 = typedArrayObtainStyledAttributes.getBoolean(R$styleable.COUICardListSelectedItemLayout_listIsTiny, false);
        this.mRadius = typedArrayObtainStyledAttributes.getDimensionPixelOffset(R$styleable.COUICardListSelectedItemLayout_couiCardRadius, COUIContextUtil.getAttrDimens(context, R$attr.couiRoundCornerM));
        init(getContext(), z10);
        this.mHorizontalMargin = typedArrayObtainStyledAttributes.getDimensionPixelOffset(R$styleable.COUICardListSelectedItemLayout_couiCardListHorizontalMargin, this.mHorizontalMargin);
