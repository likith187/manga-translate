...
final class e extends c {
    ...
    private static final g f4668q = g.encodeUtf8("'\\");

    /* JADX INFO: renamed from: r */
    private static final g f4669r = g.encodeUtf8("\"\\");

    /* JADX INFO: renamed from: s */
    private static final g f4670s = g.encodeUtf8("{}[]:, \n\t\r\f/\\;#=");

    /* JADX INFO: renamed from: t */
    private static final g f4671t = g.encodeUtf8("\n\r");

    /* JADX INFO: renamed from: u */
    private static final g f4672u = g.encodeUtf8("*/");

    /* JADX INFO: renamed from: k */
    private final f f4673k;

    /* JADX INFO: renamed from: l */
    private final t9.d f4674l;
    ...
    private int H0() throws EOFException, b {
        ...
        if (i11 == 1) {
            ...
            if (i11 == 4) {
                ...
                if (iK04 != 58) {
                    ...
                    G0();
                    if (this.f4673k.F(1L) && this.f4674l.D(0L) == 62) {
                        this.f4674l.C0();
                    }
                }
            } else if (i11 == 6) {
    ...
    private int I0(String str, c.a aVar) {
        int length = aVar.f4666a.length;
        for (int i10 = 0; i10 < length; i10++) {
            if (str.equals(aVar.f4666a[i10])) {
                this.f4675m = 0;
                this.f4662c[this.f4660a - 1] = str;
                return i10;
            }
        }
        return -1;
    ...
    /* JADX WARN: Code restructure failed: missing block: B:76:0x0037, code lost:
        ...
        if (r6.f4673k.F(2) != false) goto L78;
     */
    ...
    */
    private int K0(boolean r7) throws java.io.EOFException, com.airbnb.lottie.parser.moshi.b {
        /*
            r6 = this;
            r0 = 0
        L1:
        ...
        L6b:
            ...
            com.airbnb.lottie.parser.moshi.b r6 = r6.F0(r7)
            throw r6
        L72:
            r1 = 35
            if (r2 != r1) goto L7d
        ...
        L84:
            ...
            throw r6
        */
        throw new UnsupportedOperationException("Method not decompiled: com.airbnb.lottie.parser.moshi.e.K0(boolean):int");
    }

    private String L0(g gVar) throws EOFException, b {
        StringBuilder sb = null;
        while (true) {
            long jR = this.f4673k.R(gVar);
            if (jR == -1) {
                throw F0("Unterminated string");
            }
            if (this.f4674l.D(jR) != 92) {
                if (sb == null) {
                    String strE0 = this.f4674l.E0(jR);
                    this.f4674l.C0();
                    return strE0;
                }
                sb.append(this.f4674l.E0(jR));
                this.f4674l.C0();
                return sb.toString();
            }
            if (sb == null) {
    ...
    private String M0() {
        long jR = this.f4673k.R(f4670s);
        t9.d dVar = this.f4674l;
    ...
    private int N0() throws EOFException {
        ...
        while (i11 < length) {
            int i12 = i11 + 1;
            if (!this.f4673k.F(i12)) {
                return 0;
            }
            byte bD2 = this.f4674l.D(i11);
            if (bD2 != str.charAt(i11) && bD2 != str2.charAt(i11)) {
                return 0;
            }
            i11 = i12;
        }
        if (this.f4673k.F(length + 1) && J0(this.f4674l.D(length))) {
            return 0;
        }
        this.f4674l.A(length);
        this.f4675m = i10;
        return i10;
    }
    ...
    private int O0() throws EOFException {
        ...
        while (true) {
            int i11 = i10 + 1;
            if (!this.f4673k.F(i11)) {
                break;
            }
            bD = this.f4674l.D(i10);
            if (bD != 43) {
                if (bD == 69 || bD == 101) {
                    if (c11 != 2 && c11 != 4) {
                        return 0;
    ...
    private char P0() throws EOFException, b {
        int i10;
        if (!this.f4673k.F(1L)) {
            throw F0("Unterminated escape sequence");
        }
        byte bC0 = this.f4674l.C0();
    ...
    private void Q0(g gVar) throws EOFException, b {
        while (true) {
            long jR = this.f4673k.R(gVar);
            if (jR == -1) {
                throw F0("Unterminated string");
    ...
    public boolean B() throws EOFException, b {
        int iH0 = this.f4675m;
        if (iH0 == 0) {
            iH0 = H0();
        }
    ...
    @Override // com.airbnb.lottie.parser.moshi.c
    public boolean D() throws EOFException, b {
        int iH0 = this.f4675m;
        if (iH0 == 0) {
            iH0 = H0();
        }
    ...
    @Override // com.airbnb.lottie.parser.moshi.c
    public void D0() throws EOFException, b {
        if (this.f4665i) {
        ...
        int i12 = i11 - 1;
        iArr[i12] = iArr[i12] + 1;
        this.f4662c[i11 - 1] = AbstractJsonLexerKt.NULL;
    }

    @Override // com.airbnb.lottie.parser.moshi.c
    public double G() throws EOFException, b {
        int iH0 = this.f4675m;
        if (iH0 == 0) {
            iH0 = H0();
        }
        ...
        if (iH0 == 17) {
            this.f4678p = this.f4674l.E0(this.f4677o);
        } else if (iH0 == 9) {
            this.f4678p = L0(f4669r);
        } else if (iH0 == 8) {
            this.f4678p = L0(f4668q);
        } else if (iH0 == 10) {
            this.f4678p = M0();
        } else if (iH0 != 11) {
        ...
        this.f4675m = 11;
        try {
            double d10 = Double.parseDouble(this.f4678p);
            if (this.f4664h || !(Double.isNaN(d10) || Double.isInfinite(d10))) {
                this.f4678p = null;
                this.f4675m = 0;
                int[] iArr2 = this.f4663f;
                int i11 = this.f4660a - 1;
            ...
            throw new a("Expected a double but was " + this.f4678p + " at path " + a());
        }
    }

    @Override // com.airbnb.lottie.parser.moshi.c
    public int I() throws EOFException, b {
        int iH0 = this.f4675m;
        if (iH0 == 0) {
            iH0 = H0();
        }
        if (iH0 == 16) {
            ...
            throw new a("Expected an int but was " + this.f4676n + " at path " + a());
        }
        if (iH0 == 17) {
            this.f4678p = this.f4674l.E0(this.f4677o);
        } else if (iH0 == 9 || iH0 == 8) {
            String strL0 = iH0 == 9 ? L0(f4669r) : L0(f4668q);
            this.f4678p = strL0;
            try {
                int i12 = Integer.parseInt(strL0);
                this.f4675m = 0;
                int[] iArr2 = this.f4663f;
                int i13 = this.f4660a - 1;
        ...
        try {
            ...
            if (i14 == d10) {
                this.f4678p = null;
                this.f4675m = 0;
                int[] iArr3 = this.f4663f;
                int i15 = this.f4660a - 1;
                iArr3[i15] = iArr3[i15] + 1;
                return i14;
            }
            throw new a("Expected an int but was " + this.f4678p + " at path " + a());
    ...
    @Override // com.airbnb.lottie.parser.moshi.c
    public String N() throws EOFException, b {
        String strL0;
        int iH0 = this.f4675m;
        if (iH0 == 0) {
            iH0 = H0();
        ...
        this.f4675m = 0;
        this.f4662c[this.f4660a - 1] = strL0;
        return strL0;
    }

    @Override // com.airbnb.lottie.parser.moshi.c
    public String X() throws EOFException, b {
        String strE0;
        int iH0 = this.f4675m;
        if (iH0 == 0) {
            iH0 = H0();
        ...
        if (iH0 == 10) {
            ...
            strE0 = Long.toString(this.f4676n);
        } else {
            if (iH0 != 17) {
                throw new a("Expected a string but was " + b0() + " at path " + a());
            }
            strE0 = this.f4674l.E0(this.f4677o);
        }
        this.f4675m = 0;
        int[] iArr = this.f4663f;
        int i10 = this.f4660a - 1;
    ...
    @Override // com.airbnb.lottie.parser.moshi.c
    public c.b b0() throws EOFException, b {
        int iH0 = this.f4675m;
        if (iH0 == 0) {
            iH0 = H0();
        }
    ...
    @Override // com.airbnb.lottie.parser.moshi.c
    public void i() throws EOFException, b {
        int iH0 = this.f4675m;
        if (iH0 == 0) {
            iH0 = H0();
        }
    ...
    public String toString() {
        return "JsonReader(" + this.f4673k + ")";
    }

    @Override // com.airbnb.lottie.parser.moshi.c
    public void v() throws EOFException, b {
        int iH0 = this.f4675m;
        if (iH0 == 0) {
            iH0 = H0();
        }
    ...
    @Override // com.airbnb.lottie.parser.moshi.c
    public int v0(c.a aVar) throws EOFException, b {
        int iH0 = this.f4675m;
        if (iH0 == 0) {
            iH0 = H0();
        }
        ...
        if (iH0 == 15) {
            return I0(this.f4678p, aVar);
        }
        int iA0 = this.f4673k.A0(aVar.f4667b);
        if (iA0 != -1) {
            this.f4675m = 0;
            this.f4662c[this.f4660a - 1] = aVar.f4666a[iA0];
            return iA0;
        }
        String str = this.f4662c[this.f4660a - 1];
        String strN = N();
    ...
    @Override // com.airbnb.lottie.parser.moshi.c
    public void x() throws EOFException, b {
        int iH0 = this.f4675m;
        if (iH0 == 0) {
            iH0 = H0();
        }
    ...
    @Override // com.airbnb.lottie.parser.moshi.c
    public void x0() throws EOFException, b {
        if (this.f4665i) {
            throw new a("Cannot skip unexpected " + b0() + " at " + a());
        }
        int iH0 = this.f4675m;
        ...
        this.f4675m = 0;
        this.f4662c[this.f4660a - 1] = AbstractJsonLexerKt.NULL;
    }
}
