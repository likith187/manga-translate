...
public final class i0 {
    ...
    public static final void c(final Context context, final String text) {
        ...
        com.coloros.translate.screen.utils.t.i(new Runnable() { // from class: com.coloros.translate.utils.g0
    ...
    private static final void h(Context context, String str, List list) {
        ...
        try {
            ...
            com.coloros.translate.screen.utils.t.g(new Runnable() { // from class: com.coloros.translate.utils.h0
                @Override // java.lang.Runnable
                public final void run() {
                    i0.i();
                }
    ...
    public static final void i() {
        w.h(R$string.translate_unified_saved_note, 0, 2, null);
    }
}
