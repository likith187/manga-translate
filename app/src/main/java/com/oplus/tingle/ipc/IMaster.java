...
public interface IMaster extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IMaster {
        ...
        private static class a implements IMaster {
            ...
            public static IMaster f11209b;

            /* JADX INFO: renamed from: a, reason: collision with root package name */
            private IBinder f11210a;

            a(IBinder iBinder) {
                this.f11210a = iBinder;
            }
            ...
            public int getUid() {
                ...
                try {
                    ...
                    if (!this.f11210a.transact(4, parcelObtain, parcelObtain2, 0) && Stub.getDefaultImpl() != null) {
