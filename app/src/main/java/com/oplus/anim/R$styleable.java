...
public final class R$styleable {
    ...
    public static int EffectiveAnimationView_anim_autoPlay = 0;
    public static int EffectiveAnimationView_anim_cacheComposition = 1;
    public static int EffectiveAnimationView_anim_clipToCompositionBounds = 2;
    public static int EffectiveAnimationView_anim_colorFilter = 3;
    public static int EffectiveAnimationView_anim_defaultFontFileExtension = 4;
    public static int EffectiveAnimationView_anim_enableMergePathsForKitKatAndAbove = 5;
    public static int EffectiveAnimationView_anim_fallbackRes = 6;
    public static int EffectiveAnimationView_anim_fileName = 7;
    public static int EffectiveAnimationView_anim_ignoreDisabledSystemAnimations = 8;
    public static int EffectiveAnimationView_anim_imageAssetsFolder = 9;
    public static int EffectiveAnimationView_anim_loop = 10;
    public static int EffectiveAnimationView_anim_progress = 11;
    public static int EffectiveAnimationView_anim_rawRes = 12;
    public static int EffectiveAnimationView_anim_renderMode = 13;
    public static int EffectiveAnimationView_anim_repeatCount = 14;
    public static int EffectiveAnimationView_anim_repeatMode = 15;
    public static int EffectiveAnimationView_anim_speed = 16;
    public static int EffectiveAnimationView_anim_url = 17;
    public static int EffectiveAnimationView_anim_useCompositionFrameRate = 18;
    ...
    public static int[] EffectiveAnimationView = {R.attr.anim_autoPlay, R.attr.anim_cacheComposition, R.attr.anim_clipToCompositionBounds, R.attr.anim_colorFilter, R.attr.anim_defaultFontFileExtension, R.attr.anim_enableMergePathsForKitKatAndAbove, R.attr.anim_fallbackRes, R.attr.anim_fileName, R.attr.anim_ignoreDisabledSystemAnimations, R.attr.anim_imageAssetsFolder, R.attr.anim_loop, R.attr.anim_progress, R.attr.anim_rawRes, R.attr.anim_renderMode, R.attr.anim_repeatCount, R.attr.anim_repeatMode, R.attr.anim_speed, R.attr.anim_url, R.attr.anim_useCompositionFrameRate};
