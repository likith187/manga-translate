...
public final class SynthesizeTextExpandBuilder {
    ...
    public final SynthesizeTextExpandBuilder addCustomParam(String key, Object value) {
        r.e(key, "key");
        r.e(value, "value");
        if (key.length() > 0) {
    ...
    public final SynthesizeTextExpandBuilder addCustomParams(Map<String, ? extends Object> paramMap) {
    ...
    public final SynthesizeTextExpandBuilder setAppid(String appid) {
        r.e(appid, "appid");
        if (appid.length() > 0) {
