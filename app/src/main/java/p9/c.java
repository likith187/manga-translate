...
public final class c extends h {
    ...
    public static final a f15229e;

    /* JADX INFO: renamed from: f, reason: collision with root package name */
    private static final boolean f15230f;

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    private final Provider f15231d;
    ...
    public SSLContext m() throws NoSuchAlgorithmException {
        SSLContext sSLContext = SSLContext.getInstance("TLS", this.f15231d);
    ...
    private c() {
        this.f15231d = new BouncyCastleJsseProvider();
    }
}
