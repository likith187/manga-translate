...
.method private e(Landroid/graphics/fonts/FontFamily;I)Landroid/graphics/fonts/Font;
    ...
    invoke-static {p0, v0}, Lu/i;->g(Landroid/graphics/fonts/FontStyle;Landroid/graphics/fonts/FontStyle;)I
    ...
    invoke-static {p0, v3}, Lu/i;->g(Landroid/graphics/fonts/FontStyle;Landroid/graphics/fonts/FontStyle;)I
...
.method private static f(Landroid/os/CancellationSignal;[La0/g$b;Landroid/content/ContentResolver;)Landroid/graphics/fonts/FontFamily;
    .locals 8
    ...
    :try_start_0
    invoke-virtual {v4}, La0/g$b;->d()Landroid/net/Uri;
...
.method public a(Landroid/content/Context;Lt/e$c;Landroid/content/res/Resources;I)Landroid/graphics/Typeface;
    ...
    invoke-virtual {v3}, Lt/e$d;->c()Ljava/lang/String;
    ...
    invoke-direct {p0, p2, p4}, Lu/i;->e(Landroid/graphics/fonts/FontFamily;I)Landroid/graphics/fonts/Font;
...
.method public b(Landroid/content/Context;Landroid/os/CancellationSignal;[La0/g$b;I)Landroid/graphics/Typeface;
    .locals 1
    ...
    :try_start_0
    invoke-static {p2, p3, p1}, Lu/i;->f(Landroid/os/CancellationSignal;[La0/g$b;Landroid/content/ContentResolver;)Landroid/graphics/fonts/FontFamily;
    ...
    invoke-direct {p0, p1, p4}, Lu/i;->e(Landroid/graphics/fonts/FontFamily;I)Landroid/graphics/fonts/Font;
...
.method public c(Landroid/content/Context;Landroid/os/CancellationSignal;Ljava/util/List;I)Landroid/graphics/Typeface;
    ...
    invoke-static {p2, v0, p1}, Lu/i;->f(Landroid/os/CancellationSignal;[La0/g$b;Landroid/content/ContentResolver;)Landroid/graphics/fonts/FontFamily;
    ...
    check-cast v4, [La0/g$b;

    invoke-static {p2, v4, p1}, Lu/i;->f(Landroid/os/CancellationSignal;[La0/g$b;Landroid/content/ContentResolver;)Landroid/graphics/fonts/FontFamily;
    ...
    :cond_2
    invoke-direct {p0, v0, p4}, Lu/i;->e(Landroid/graphics/fonts/FontFamily;I)Landroid/graphics/fonts/Font;
