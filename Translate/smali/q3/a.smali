...
.field private static volatile c:Lq3/a;
...
.method private final e(Landroid/content/Context;Ljava/lang/String;Landroid/content/Intent;Landroid/content/ServiceConnection;IZLjava/util/concurrent/Executor;)Z
    ...
    :try_start_0
    invoke-static {p1}, Ls3/c;->a(Landroid/content/Context;)Ls3/b;

    move-result-object v2

    invoke-virtual {v2, p6, v1}, Ls3/b;->a(Ljava/lang/String;I)Landroid/content/pm/ApplicationInfo;
    ...
    :cond_1
    :goto_0
    invoke-static {p4}, Lq3/a;->f(Landroid/content/ServiceConnection;)Z

    move-result p6

    if-eqz p6, :cond_4

    iget-object p6, p0, Lq3/a;->a:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    :cond_2
    :try_start_1
    invoke-static {p1, p3, p4, p5, p7}, Lq3/a;->g(Landroid/content/Context;Landroid/content/Intent;Landroid/content/ServiceConnection;ILjava/util/concurrent/Executor;)Z
    ...
    :cond_3
    iget-object p0, p0, Lq3/a;->a:Ljava/util/concurrent/ConcurrentHashMap;
...
.method private static f(Landroid/content/ServiceConnection;)Z
    ...
    instance-of p0, p0, Lcom/google/android/gms/common/internal/e1;
...
.method public b(Landroid/content/Context;Landroid/content/ServiceConnection;)V
    ...
    invoke-static {p2}, Lq3/a;->f(Landroid/content/ServiceConnection;)Z
    ...
    invoke-static {p1, v0}, Lq3/a;->d(Landroid/content/Context;Landroid/content/ServiceConnection;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    :cond_0
    invoke-static {p1, p2}, Lq3/a;->d(Landroid/content/Context;Landroid/content/ServiceConnection;)V
...
.method public final c(Landroid/content/Context;Ljava/lang/String;Landroid/content/Intent;Landroid/content/ServiceConnection;ILjava/util/concurrent/Executor;)Z
    ...
    invoke-direct/range {v0 .. v7}, Lq3/a;->e(Landroid/content/Context;Ljava/lang/String;Landroid/content/Intent;Landroid/content/ServiceConnection;IZLjava/util/concurrent/Executor;)Z
