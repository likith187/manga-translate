...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Landroidx/window/layout/WindowInfoTrackerImpl;->a(Landroid/app/Activity;)Lkotlinx/coroutines/flow/b;
.end annotation
...
.method public static synthetic b(Lkotlinx/coroutines/channels/d;Landroidx/window/layout/WindowLayoutInfo;)V
    .locals 0

    invoke-static {p0, p1}, Landroidx/window/layout/WindowInfoTrackerImpl$windowLayoutInfo$1;->invokeSuspend$lambda-0(Lkotlinx/coroutines/channels/d;Landroidx/window/layout/WindowLayoutInfo;)V

    return-void
.end method

.method private static final invokeSuspend$lambda-0(Lkotlinx/coroutines/channels/d;Landroidx/window/layout/WindowLayoutInfo;)V
    .locals 1
    ...
    invoke-interface {p0, p1}, Lkotlinx/coroutines/channels/n;->a(Ljava/lang/Object;)Ljava/lang/Object;
...
.method public final create(Ljava/lang/Object;Lkotlin/coroutines/d;)Lkotlin/coroutines/d;
    ...
    invoke-direct {v0, v1, p0, p2}, Landroidx/window/layout/WindowInfoTrackerImpl$windowLayoutInfo$1;-><init>(Landroidx/window/layout/WindowInfoTrackerImpl;Landroid/app/Activity;Lkotlin/coroutines/d;)V
...
.method public bridge synthetic invoke(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1, p2}, Landroidx/window/layout/WindowInfoTrackerImpl$windowLayoutInfo$1;->invoke(Lkotlinx/coroutines/flow/c;Lkotlin/coroutines/d;)Ljava/lang/Object;
...
.method public final invoke(Lkotlinx/coroutines/flow/c;Lkotlin/coroutines/d;)Ljava/lang/Object;
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public final invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-static {v5, v1, v6, v4, v6}, Lkotlinx/coroutines/channels/f;->b(ILkotlinx/coroutines/channels/a;Lw8/l;ILjava/lang/Object;)Lkotlinx/coroutines/channels/d;

    move-result-object v1

    new-instance v4, Landroidx/window/layout/b;

    invoke-direct {v4, v1}, Landroidx/window/layout/b;-><init>(Lkotlinx/coroutines/channels/d;)V
    ...
    invoke-interface {v5, v6, v7, v4}, Landroidx/window/layout/WindowBackend;->a(Landroid/app/Activity;Ljava/util/concurrent/Executor;Lc0/a;)V

    :try_start_2
    invoke-interface {v1}, Lkotlinx/coroutines/channels/m;->iterator()Lkotlinx/coroutines/channels/e;
    ...
    invoke-interface {v1, p0}, Lkotlinx/coroutines/channels/e;->a(Lkotlin/coroutines/d;)Ljava/lang/Object;
    ...
    invoke-interface {v1}, Lkotlinx/coroutines/channels/e;->next()Ljava/lang/Object;
    ...
    invoke-interface {v5, p1, p0}, Lkotlinx/coroutines/flow/c;->emit(Ljava/lang/Object;Lkotlin/coroutines/d;)Ljava/lang/Object;
    ...
    invoke-static {p0}, Landroidx/window/layout/WindowInfoTrackerImpl;->b(Landroidx/window/layout/WindowInfoTrackerImpl;)Landroidx/window/layout/WindowBackend;

    move-result-object p0

    invoke-interface {p0, v4}, Landroidx/window/layout/WindowBackend;->b(Lc0/a;)V
