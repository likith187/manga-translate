...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Landroidx/window/embedding/EmbeddingCompat;->a(Landroidx/window/embedding/EmbeddingInterfaceCompat$EmbeddingCallbackInterface;)V
.end annotation
...
.method public final invoke(Ljava/util/List;)V
    ...
    invoke-static {p0}, Landroidx/window/embedding/EmbeddingCompat;->b(Landroidx/window/embedding/EmbeddingCompat;)Landroidx/window/embedding/EmbeddingAdapter;

    move-result-object p0

    invoke-virtual {p0, v0}, Landroidx/window/embedding/EmbeddingAdapter;->b(Ljava/util/List;)Ljava/util/List;

    move-result-object p0

    invoke-interface {p1, p0}, Landroidx/window/embedding/EmbeddingInterfaceCompat$EmbeddingCallbackInterface;->a(Ljava/util/List;)V
