...
.field private static sSharedValues:Landroidx/constraintlayout/widget/e;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    .line 25
    invoke-direct {p0, v0, p1, p1}, Landroidx/constraintlayout/widget/ConstraintLayout;->c(Landroid/util/AttributeSet;II)V
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    .line 50
    invoke-direct {p0, p2, p1, p1}, Landroidx/constraintlayout/widget/ConstraintLayout;->c(Landroid/util/AttributeSet;II)V
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    .line 75
    invoke-direct {p0, p2, p3, p1}, Landroidx/constraintlayout/widget/ConstraintLayout;->c(Landroid/util/AttributeSet;II)V

    return-void
.end method

.method static synthetic access$000(Landroidx/constraintlayout/widget/ConstraintLayout;)Ll/e;
    .locals 0
...
.method private c(Landroid/util/AttributeSet;II)V
    ...
    invoke-virtual {v0, p0}, Lo/e;->G0(Ljava/lang/Object;)V
    ...
    invoke-virtual {v0, v1}, Lo/f;->b2(Lp/b$b;)V
    ...
    invoke-virtual {p1, p0}, Lo/f;->c2(I)V
...
.method private e()V
    ...
    invoke-direct {p0, v3}, Landroidx/constraintlayout/widget/ConstraintLayout;->b(I)Lo/e;

    move-result-object v3

    invoke-virtual {v3, v4}, Lo/e;->H0(Ljava/lang/String;)V
    :try_end_0
    .catch Landroid/content/res/Resources$NotFoundException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-virtual {v0, v3}, Lo/n;->b(Lo/e;)V
    ...
    invoke-virtual/range {v0 .. v5}, Landroidx/constraintlayout/widget/ConstraintLayout;->applyConstraintsFromLayoutParams(ZLandroid/view/View;Lo/e;Landroidx/constraintlayout/widget/ConstraintLayout$b;Landroid/util/SparseArray;)V
...
.method private f(Lo/e;Landroidx/constraintlayout/widget/ConstraintLayout$b;Landroid/util/SparseArray;ILo/d$a;)V
    .locals 1
    ...
    iput-boolean p4, p2, Landroidx/constraintlayout/widget/ConstraintLayout$b;->mNeedsBaseline:Z

    sget-object v0, Lo/d$a;->BASELINE:Lo/d$a;
    ...
    iput-boolean p4, p0, Landroidx/constraintlayout/widget/ConstraintLayout$b;->mNeedsBaseline:Z

    iget-object p0, p0, Landroidx/constraintlayout/widget/ConstraintLayout$b;->mWidget:Lo/e;

    invoke-virtual {p0, p4}, Lo/e;->P0(Z)V

    :cond_0
    invoke-virtual {p1, v0}, Lo/e;->q(Lo/d$a;)Lo/d;

    move-result-object p0

    invoke-virtual {p3, p5}, Lo/e;->q(Lo/d$a;)Lo/d;

    move-result-object p3

    iget p5, p2, Landroidx/constraintlayout/widget/ConstraintLayout$b;->baselineMargin:I

    iget p2, p2, Landroidx/constraintlayout/widget/ConstraintLayout$b;->goneBaselineMargin:I

    invoke-virtual {p0, p3, p5, p2, p4}, Lo/d;->b(Lo/d;IIZ)Z

    invoke-virtual {p1, p4}, Lo/e;->P0(Z)V

    sget-object p0, Lo/d$a;->TOP:Lo/d$a;

    invoke-virtual {p1, p0}, Lo/e;->q(Lo/d$a;)Lo/d;
...
.method public static getSharedValues()Landroidx/constraintlayout/widget/e;
    .locals 1

    sget-object v0, Landroidx/constraintlayout/widget/ConstraintLayout;->sSharedValues:Landroidx/constraintlayout/widget/e;
    ...
    sput-object v0, Landroidx/constraintlayout/widget/ConstraintLayout;->sSharedValues:Landroidx/constraintlayout/widget/e;
...
.method protected applyConstraintsFromLayoutParams(ZLandroid/view/View;Lo/e;Landroidx/constraintlayout/widget/ConstraintLayout$b;Landroid/util/SparseArray;)V
    .locals 16
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(Z",
    ...
    invoke-virtual/range {p4 .. p4}, Landroidx/constraintlayout/widget/ConstraintLayout$b;->validate()V

    const/4 v9, 0x0

    iput-boolean v9, v7, Landroidx/constraintlayout/widget/ConstraintLayout$b;->helped:Z
    ...
    iget-boolean v1, v7, Landroidx/constraintlayout/widget/ConstraintLayout$b;->mIsInPlaceholder:Z

    if-eqz v1, :cond_0

    const/4 v1, 0x1

    invoke-virtual {v6, v1}, Lo/e;->Y0(Z)V
    ...
    :cond_0
    invoke-virtual {v6, v0}, Lo/e;->G0(Ljava/lang/Object;)V
    ...
    :goto_0
    iget-boolean v0, v7, Landroidx/constraintlayout/widget/ConstraintLayout$b;->mIsGuideline:Z
    ...
    iget v1, v7, Landroidx/constraintlayout/widget/ConstraintLayout$b;->mResolvedGuideBegin:I

    iget v2, v7, Landroidx/constraintlayout/widget/ConstraintLayout$b;->mResolvedGuideEnd:I

    iget v3, v7, Landroidx/constraintlayout/widget/ConstraintLayout$b;->mResolvedGuidePercent:F
    ...
    invoke-virtual {v0, v3}, Lo/h;->E1(F)V
    ...
    invoke-virtual {v0, v1}, Lo/h;->C1(I)V
    ...
    invoke-virtual {v0, v2}, Lo/h;->D1(I)V

    goto/16 :goto_b

    :cond_4
    iget v0, v7, Landroidx/constraintlayout/widget/ConstraintLayout$b;->mResolvedLeftToLeft:I

    iget v1, v7, Landroidx/constraintlayout/widget/ConstraintLayout$b;->mResolvedLeftToRight:I

    iget v12, v7, Landroidx/constraintlayout/widget/ConstraintLayout$b;->mResolvedRightToLeft:I

    iget v13, v7, Landroidx/constraintlayout/widget/ConstraintLayout$b;->mResolvedRightToRight:I

    iget v5, v7, Landroidx/constraintlayout/widget/ConstraintLayout$b;->mResolveGoneLeftMargin:I

    iget v14, v7, Landroidx/constraintlayout/widget/ConstraintLayout$b;->mResolveGoneRightMargin:I

    iget v15, v7, Landroidx/constraintlayout/widget/ConstraintLayout$b;->mResolvedHorizontalBias:F

    iget v2, v7, Landroidx/constraintlayout/widget/ConstraintLayout$b;->circleConstraint:I
    ...
    iget v1, v7, Landroidx/constraintlayout/widget/ConstraintLayout$b;->circleAngle:F

    iget v2, v7, Landroidx/constraintlayout/widget/ConstraintLayout$b;->circleRadius:I
    ...
    :cond_9
    :goto_2
    iget v0, v7, Landroidx/constraintlayout/widget/ConstraintLayout$b;->topToTop:I
    ...
    iget v5, v7, Landroidx/constraintlayout/widget/ConstraintLayout$b;->goneTopMargin:I
    ...
    :cond_a
    iget v0, v7, Landroidx/constraintlayout/widget/ConstraintLayout$b;->topToBottom:I
    ...
    :cond_b
    :goto_3
    iget v0, v7, Landroidx/constraintlayout/widget/ConstraintLayout$b;->bottomToTop:I
    ...
    iget v5, v7, Landroidx/constraintlayout/widget/ConstraintLayout$b;->goneBottomMargin:I
    ...
    :cond_c
    iget v0, v7, Landroidx/constraintlayout/widget/ConstraintLayout$b;->bottomToBottom:I
    ...
    :cond_d
    :goto_4
    iget v4, v7, Landroidx/constraintlayout/widget/ConstraintLayout$b;->baselineToBaseline:I
    ...
    invoke-direct/range {v0 .. v5}, Landroidx/constraintlayout/widget/ConstraintLayout;->f(Lo/e;Landroidx/constraintlayout/widget/ConstraintLayout$b;Landroid/util/SparseArray;ILo/d$a;)V

    goto :goto_5

    :cond_e
    iget v4, v7, Landroidx/constraintlayout/widget/ConstraintLayout$b;->baselineToTop:I
    ...
    :cond_f
    iget v4, v7, Landroidx/constraintlayout/widget/ConstraintLayout$b;->baselineToBottom:I
    ...
    invoke-virtual {v6, v15}, Lo/e;->R0(F)V

    :cond_11
    iget v1, v7, Landroidx/constraintlayout/widget/ConstraintLayout$b;->verticalBias:F

    cmpl-float v0, v1, v0

    if-ltz v0, :cond_12

    invoke-virtual {v6, v1}, Lo/e;->i1(F)V

    :cond_12
    :goto_6
    if-eqz p1, :cond_14

    iget v0, v7, Landroidx/constraintlayout/widget/ConstraintLayout$b;->editorAbsoluteX:I

    if-ne v0, v11, :cond_13

    iget v1, v7, Landroidx/constraintlayout/widget/ConstraintLayout$b;->editorAbsoluteY:I
    ...
    invoke-virtual {v6, v0, v1}, Lo/e;->g1(II)V

    :cond_14
    iget-boolean v0, v7, Landroidx/constraintlayout/widget/ConstraintLayout$b;->mHorizontalDimensionFixed:Z
    ...
    iget-boolean v0, v7, Landroidx/constraintlayout/widget/ConstraintLayout$b;->constrainedWidth:Z

    if-eqz v0, :cond_15

    sget-object v0, Lo/e$b;->MATCH_CONSTRAINT:Lo/e$b;

    invoke-virtual {v6, v0}, Lo/e;->U0(Lo/e$b;)V
    ...
    invoke-virtual {v6, v0}, Lo/e;->q(Lo/d$a;)Lo/d;
    ...
    sget-object v0, Lo/d$a;->RIGHT:Lo/d$a;
    ...
    invoke-virtual {v6, v9}, Lo/e;->p1(I)V
    ...
    :cond_18
    :goto_8
    iget-boolean v0, v7, Landroidx/constraintlayout/widget/ConstraintLayout$b;->mVerticalDimensionFixed:Z
    ...
    iget-boolean v0, v7, Landroidx/constraintlayout/widget/ConstraintLayout$b;->constrainedHeight:Z

    if-eqz v0, :cond_19

    sget-object v0, Lo/e$b;->MATCH_CONSTRAINT:Lo/e$b;

    invoke-virtual {v6, v0}, Lo/e;->l1(Lo/e$b;)V
    ...
    sget-object v0, Lo/d$a;->BOTTOM:Lo/d$a;
    ...
    invoke-virtual {v6, v9}, Lo/e;->Q0(I)V
    ...
    invoke-virtual {v6, v0}, Lo/e;->Q0(I)V
    ...
    :cond_1c
    :goto_a
    iget-object v0, v7, Landroidx/constraintlayout/widget/ConstraintLayout$b;->dimensionRatio:Ljava/lang/String;

    invoke-virtual {v6, v0}, Lo/e;->I0(Ljava/lang/String;)V

    iget v0, v7, Landroidx/constraintlayout/widget/ConstraintLayout$b;->horizontalWeight:F

    invoke-virtual {v6, v0}, Lo/e;->W0(F)V

    iget v0, v7, Landroidx/constraintlayout/widget/ConstraintLayout$b;->verticalWeight:F

    invoke-virtual {v6, v0}, Lo/e;->n1(F)V

    iget v0, v7, Landroidx/constraintlayout/widget/ConstraintLayout$b;->horizontalChainStyle:I

    invoke-virtual {v6, v0}, Lo/e;->S0(I)V

    iget v0, v7, Landroidx/constraintlayout/widget/ConstraintLayout$b;->verticalChainStyle:I

    invoke-virtual {v6, v0}, Lo/e;->j1(I)V

    iget v0, v7, Landroidx/constraintlayout/widget/ConstraintLayout$b;->wrapBehaviorInParent:I

    invoke-virtual {v6, v0}, Lo/e;->q1(I)V

    iget v0, v7, Landroidx/constraintlayout/widget/ConstraintLayout$b;->matchConstraintDefaultWidth:I

    iget v1, v7, Landroidx/constraintlayout/widget/ConstraintLayout$b;->matchConstraintMinWidth:I

    iget v2, v7, Landroidx/constraintlayout/widget/ConstraintLayout$b;->matchConstraintMaxWidth:I

    iget v3, v7, Landroidx/constraintlayout/widget/ConstraintLayout$b;->matchConstraintPercentWidth:F

    invoke-virtual {v6, v0, v1, v2, v3}, Lo/e;->V0(IIIF)V

    iget v0, v7, Landroidx/constraintlayout/widget/ConstraintLayout$b;->matchConstraintDefaultHeight:I

    iget v1, v7, Landroidx/constraintlayout/widget/ConstraintLayout$b;->matchConstraintMinHeight:I

    iget v2, v7, Landroidx/constraintlayout/widget/ConstraintLayout$b;->matchConstraintMaxHeight:I

    iget v3, v7, Landroidx/constraintlayout/widget/ConstraintLayout$b;->matchConstraintPercentHeight:F

    invoke-virtual {v6, v0, v1, v2, v3}, Lo/e;->m1(IIIF)V
...
.method protected dynamicUpdateConstraints(II)Z
    ...
    invoke-virtual {p0}, Lo/e;->u()Ljava/lang/Object;
...
.method public fillMetrics(Ll/e;)V
    ...
    invoke-virtual {p0, p1}, Lo/f;->N1(Ll/e;)V
...
.method public getSceneString()Ljava/lang/String;
    ...
    invoke-virtual {v1, v5}, Lo/e;->H0(Ljava/lang/String;)V
    ...
    invoke-virtual {v1}, Lo/n;->w1()Ljava/util/ArrayList;
    ...
    invoke-virtual {v5, v6}, Lo/e;->H0(Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v0}, Lo/f;->Q(Ljava/lang/StringBuilder;)V
...
.method protected onLayout(ZIIII)V
    ...
    iget-object v1, v0, Landroidx/constraintlayout/widget/ConstraintLayout$b;->mWidget:Lo/e;
    ...
    iget-boolean v2, v0, Landroidx/constraintlayout/widget/ConstraintLayout$b;->mIsGuideline:Z

    if-nez v2, :cond_0

    iget-boolean v2, v0, Landroidx/constraintlayout/widget/ConstraintLayout$b;->mIsHelper:Z

    if-nez v2, :cond_0

    iget-boolean v2, v0, Landroidx/constraintlayout/widget/ConstraintLayout$b;->mIsVirtualGroup:Z
    ...
    :cond_0
    iget-boolean v0, v0, Landroidx/constraintlayout/widget/ConstraintLayout$b;->mIsInPlaceholder:Z
...
.method protected onMeasure(II)V
    ...
    invoke-virtual {v0, v2}, Lo/f;->e2(Z)V
    ...
    invoke-virtual {v0, v1}, Lo/f;->N1(Ll/e;)V
...
.method public onViewAdded(Landroid/view/View;)V
    ...
    iput-object v1, v0, Landroidx/constraintlayout/widget/ConstraintLayout$b;->mWidget:Lo/e;

    iput-boolean v2, v0, Landroidx/constraintlayout/widget/ConstraintLayout$b;->mIsGuideline:Z

    iget v0, v0, Landroidx/constraintlayout/widget/ConstraintLayout$b;->orientation:I

    invoke-virtual {v1, v0}, Lo/h;->F1(I)V
    ...
    iput-boolean v2, v1, Landroidx/constraintlayout/widget/ConstraintLayout$b;->mIsHelper:Z
...
.method public onViewRemoved(Landroid/view/View;)V
    ...
    invoke-virtual {v1, v0}, Lo/n;->y1(Lo/e;)V
...
.method protected resolveSystem(Lo/f;III)V
    ...
    invoke-virtual/range {v0 .. v9}, Lo/f;->X1(IIIIIIIII)J
...
.method public setOnConstraintsChanged(Landroidx/constraintlayout/widget/d;)V
    ...
    invoke-virtual {p0, p1}, Landroidx/constraintlayout/widget/b;->c(Landroidx/constraintlayout/widget/d;)V
...
.method public setOptimizationLevel(I)V
    ...
    invoke-virtual {p0, p1}, Lo/f;->c2(I)V
...
.method protected setSelfDimensionBehaviour(Lo/f;IIII)V
    ...
    invoke-virtual {p1, v6}, Lo/e;->f1(I)V

    invoke-virtual {p1, v6}, Lo/e;->e1(I)V

    invoke-virtual {p1, p2}, Lo/e;->U0(Lo/e$b;)V

    invoke-virtual {p1, p3}, Lo/e;->p1(I)V

    invoke-virtual {p1, v2}, Lo/e;->l1(Lo/e$b;)V
    ...
    invoke-virtual {p1, p0}, Lo/e;->e1(I)V
