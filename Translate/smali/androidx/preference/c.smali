...
.method public static newInstance(Ljava/lang/String;)Landroidx/preference/c;
    .locals 3
...
.method private o()Landroidx/preference/ListPreference;
    .locals 0
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    invoke-direct {p0}, Landroidx/preference/c;->o()Landroidx/preference/ListPreference;
    ...
    iput v0, p0, Landroidx/preference/c;->mClickedDialogEntryIndex:I

    invoke-virtual {p1}, Landroidx/preference/ListPreference;->getEntries()[Ljava/lang/CharSequence;

    move-result-object v0

    iput-object v0, p0, Landroidx/preference/c;->mEntries:[Ljava/lang/CharSequence;

    invoke-virtual {p1}, Landroidx/preference/ListPreference;->getEntryValues()[Ljava/lang/CharSequence;

    move-result-object p1

    iput-object p1, p0, Landroidx/preference/c;->mEntryValues:[Ljava/lang/CharSequence;
...
.method public onDialogClosed(Z)V
    ...
    iget p1, p0, Landroidx/preference/c;->mClickedDialogEntryIndex:I

    if-ltz p1, :cond_0

    iget-object v0, p0, Landroidx/preference/c;->mEntryValues:[Ljava/lang/CharSequence;
...
.method protected onPrepareDialogBuilder(Landroidx/appcompat/app/c$a;)V
    ...
    iget-object v0, p0, Landroidx/preference/c;->mEntries:[Ljava/lang/CharSequence;

    iget v1, p0, Landroidx/preference/c;->mClickedDialogEntryIndex:I
    ...
    invoke-virtual {p1, p0, p0}, Landroidx/appcompat/app/c$a;->setPositiveButton(Ljava/lang/CharSequence;Landroid/content/DialogInterface$OnClickListener;)Landroidx/appcompat/app/c$a;
...
.method public onSaveInstanceState(Landroid/os/Bundle;)V
    ...
    iget-object v1, p0, Landroidx/preference/c;->mEntries:[Ljava/lang/CharSequence;

    invoke-virtual {p1, v0, v1}, Landroid/os/Bundle;->putCharSequenceArray(Ljava/lang/String;[Ljava/lang/CharSequence;)V

    const-string v0, "ListPreferenceDialogFragment.entryValues"

    iget-object p0, p0, Landroidx/preference/c;->mEntryValues:[Ljava/lang/CharSequence;
