...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Landroidx/preference/d;->mNewValues:Ljava/util/Set;

    return-void
.end method

.method public static newInstance(Ljava/lang/String;)Landroidx/preference/d;
    .locals 3
...
.method private o()Landroidx/preference/MultiSelectListPreference;
    .locals 0
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    invoke-direct {p0}, Landroidx/preference/d;->o()Landroidx/preference/MultiSelectListPreference;
    ...
    iget-object v1, p0, Landroidx/preference/d;->mNewValues:Ljava/util/Set;
    ...
    iput-boolean v0, p0, Landroidx/preference/d;->mPreferenceChanged:Z

    invoke-virtual {p1}, Landroidx/preference/MultiSelectListPreference;->getEntries()[Ljava/lang/CharSequence;

    move-result-object v0

    iput-object v0, p0, Landroidx/preference/d;->mEntries:[Ljava/lang/CharSequence;

    invoke-virtual {p1}, Landroidx/preference/MultiSelectListPreference;->getEntryValues()[Ljava/lang/CharSequence;

    move-result-object p1

    iput-object p1, p0, Landroidx/preference/d;->mEntryValues:[Ljava/lang/CharSequence;
...
.method public onDialogClosed(Z)V
    ...
    iget-object v0, p0, Landroidx/preference/d;->mNewValues:Ljava/util/Set;
...
.method protected onPrepareDialogBuilder(Landroidx/appcompat/app/c$a;)V
    ...
    invoke-super {p0, p1}, Landroidx/preference/f;->onPrepareDialogBuilder(Landroidx/appcompat/app/c$a;)V
    ...
    iget-object v3, p0, Landroidx/preference/d;->mNewValues:Ljava/util/Set;

    iget-object v4, p0, Landroidx/preference/d;->mEntryValues:[Ljava/lang/CharSequence;
    ...
    :cond_0
    iget-object v0, p0, Landroidx/preference/d;->mEntries:[Ljava/lang/CharSequence;
...
.method public onSaveInstanceState(Landroid/os/Bundle;)V
    ...
    iget-boolean v1, p0, Landroidx/preference/d;->mPreferenceChanged:Z

    invoke-virtual {p1, v0, v1}, Landroid/os/BaseBundle;->putBoolean(Ljava/lang/String;Z)V

    const-string v0, "MultiSelectListPreferenceDialogFragmentCompat.entries"

    iget-object v1, p0, Landroidx/preference/d;->mEntries:[Ljava/lang/CharSequence;

    invoke-virtual {p1, v0, v1}, Landroid/os/Bundle;->putCharSequenceArray(Ljava/lang/String;[Ljava/lang/CharSequence;)V

    const-string v0, "MultiSelectListPreferenceDialogFragmentCompat.entryValues"

    iget-object p0, p0, Landroidx/preference/d;->mEntryValues:[Ljava/lang/CharSequence;
