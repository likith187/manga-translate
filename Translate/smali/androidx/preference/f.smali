...
.method private n(Landroid/app/Dialog;)V
    .locals 0
...
.method public getPreference()Landroidx/preference/DialogPreference;
    ...
    iget-object v0, p0, Landroidx/preference/f;->mPreference:Landroidx/preference/DialogPreference;
    ...
    iput-object v0, p0, Landroidx/preference/f;->mPreference:Landroidx/preference/DialogPreference;

    :cond_0
    iget-object p0, p0, Landroidx/preference/f;->mPreference:Landroidx/preference/DialogPreference;
...
.method protected onBindDialogView(Landroid/view/View;)V
    ...
    iget-object p0, p0, Landroidx/preference/f;->mDialogMessage:Ljava/lang/CharSequence;
...
.method public onClick(Landroid/content/DialogInterface;I)V
    ...
    iput p2, p0, Landroidx/preference/f;->mWhichButtonClicked:I
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    iput-object p1, p0, Landroidx/preference/f;->mPreference:Landroidx/preference/DialogPreference;

    invoke-virtual {p1}, Landroidx/preference/DialogPreference;->getDialogTitle()Ljava/lang/CharSequence;

    move-result-object p1

    iput-object p1, p0, Landroidx/preference/f;->mDialogTitle:Ljava/lang/CharSequence;

    iget-object p1, p0, Landroidx/preference/f;->mPreference:Landroidx/preference/DialogPreference;

    invoke-virtual {p1}, Landroidx/preference/DialogPreference;->getPositiveButtonText()Ljava/lang/CharSequence;

    move-result-object p1

    iput-object p1, p0, Landroidx/preference/f;->mPositiveButtonText:Ljava/lang/CharSequence;
    ...
    iput-object p1, p0, Landroidx/preference/f;->mNegativeButtonText:Ljava/lang/CharSequence;
    ...
    iput-object p1, p0, Landroidx/preference/f;->mDialogMessage:Ljava/lang/CharSequence;
    ...
    iput p1, p0, Landroidx/preference/f;->mDialogLayoutRes:I
    ...
    iput-object p1, p0, Landroidx/preference/f;->mDialogIcon:Landroid/graphics/drawable/BitmapDrawable;
    ...
    iput-object v0, p0, Landroidx/preference/f;->mDialogTitle:Ljava/lang/CharSequence;
    ...
    iput-object v0, p0, Landroidx/preference/f;->mPositiveButtonText:Ljava/lang/CharSequence;
    ...
    iput-object v0, p0, Landroidx/preference/f;->mNegativeButtonText:Ljava/lang/CharSequence;
    ...
    iput-object v0, p0, Landroidx/preference/f;->mDialogMessage:Ljava/lang/CharSequence;
    ...
    iput v0, p0, Landroidx/preference/f;->mDialogLayoutRes:I
    ...
    iput-object v0, p0, Landroidx/preference/f;->mDialogIcon:Landroid/graphics/drawable/BitmapDrawable;
...
.method public onCreateDialog(Landroid/os/Bundle;)Landroid/app/Dialog;
    ...
    iget-object v1, p0, Landroidx/preference/f;->mNegativeButtonText:Ljava/lang/CharSequence;
    ...
    invoke-virtual {p0, p1}, Landroidx/preference/f;->onBindDialogView(Landroid/view/View;)V
    ...
    :cond_0
    iget-object p1, p0, Landroidx/preference/f;->mDialogMessage:Ljava/lang/CharSequence;
    ...
    invoke-virtual {p0}, Landroidx/preference/f;->needInputMethod()Z

    move-result v0

    if-eqz v0, :cond_1

    invoke-direct {p0, p1}, Landroidx/preference/f;->n(Landroid/app/Dialog;)V
...
.method protected onCreateDialogView(Landroid/content/Context;)Landroid/view/View;
    ...
    iget p0, p0, Landroidx/preference/f;->mDialogLayoutRes:I
...
.method public onDismiss(Landroid/content/DialogInterface;)V
    ...
    iget p1, p0, Landroidx/preference/f;->mWhichButtonClicked:I
    ...
    :goto_0
    invoke-virtual {p0, p1}, Landroidx/preference/f;->onDialogClosed(Z)V

    return-void
.end method

.method protected onPrepareDialogBuilder(Landroidx/appcompat/app/c$a;)V
    .locals 0
...
.method public onSaveInstanceState(Landroid/os/Bundle;)V
    ...
    iget-object v1, p0, Landroidx/preference/f;->mDialogMessage:Ljava/lang/CharSequence;

    invoke-virtual {p1, v0, v1}, Landroid/os/Bundle;->putCharSequence(Ljava/lang/String;Ljava/lang/CharSequence;)V

    const-string v0, "PreferenceDialogFragment.layout"

    iget v1, p0, Landroidx/preference/f;->mDialogLayoutRes:I

    invoke-virtual {p1, v0, v1}, Landroid/os/BaseBundle;->putInt(Ljava/lang/String;I)V

    iget-object p0, p0, Landroidx/preference/f;->mDialogIcon:Landroid/graphics/drawable/BitmapDrawable;
