...
.method private constructor <init>(Landroid/view/accessibility/AccessibilityNodeInfo;)V
    ...
    iput-object p1, p0, Ld0/h;->a:Landroid/view/accessibility/AccessibilityNodeInfo;
...
.method private B()Z
    ...
    invoke-direct {p0, v0}, Ld0/h;->f(Ljava/lang/String;)Ljava/util/List;
...
.method public static M0(Landroid/view/accessibility/AccessibilityNodeInfo;)Ld0/h;
    .locals 1

    new-instance v0, Ld0/h;

    invoke-direct {v0, p0}, Ld0/h;-><init>(Landroid/view/accessibility/AccessibilityNodeInfo;)V

    return-object v0
.end method

.method public static V()Ld0/h;
    .locals 1
    ...
    invoke-static {v0}, Ld0/h;->M0(Landroid/view/accessibility/AccessibilityNodeInfo;)Ld0/h;
...
.method public static W(Landroid/view/View;)Ld0/h;
    .locals 0
    ...
    invoke-static {p0}, Ld0/h;->M0(Landroid/view/accessibility/AccessibilityNodeInfo;)Ld0/h;
...
.method public static X(Ld0/h;)Ld0/h;
    .locals 0

    iget-object p0, p0, Ld0/h;->a:Landroid/view/accessibility/AccessibilityNodeInfo;
...
.method private f(Ljava/lang/String;)Ljava/util/List;
    ...
    iget-object v0, p0, Ld0/h;->a:Landroid/view/accessibility/AccessibilityNodeInfo;
...
.method private j(I)Z
    ...
    invoke-virtual {p0}, Ld0/h;->t()Landroid/os/Bundle;
...
.method public C()Z
    ...
    invoke-static {p0}, Ld0/h$d;->d(Landroid/view/accessibility/AccessibilityNodeInfo;)Z
    ...
    invoke-direct {p0, v0}, Ld0/h;->j(I)Z
...
.method public H0(Ljava/lang/CharSequence;)V
    ...
    invoke-static {p0, p1}, Ld0/h$b;->b(Landroid/view/accessibility/AccessibilityNodeInfo;Ljava/lang/CharSequence;)V
...
.method public T()Z
    ...
    invoke-static {p0}, Ld0/h$c;->b(Landroid/view/accessibility/AccessibilityNodeInfo;)Z
...
.method public a0(Ld0/h$a;)Z
    .locals 0

    iget-object p0, p0, Ld0/h;->a:Landroid/view/accessibility/AccessibilityNodeInfo;

    iget-object p1, p1, Ld0/h$a;->a:Ljava/lang/Object;
...
.method public equals(Ljava/lang/Object;)Z
    ...
    iget-object v2, p0, Ld0/h;->a:Landroid/view/accessibility/AccessibilityNodeInfo;

    if-nez v2, :cond_3

    iget-object v2, p1, Ld0/h;->a:Landroid/view/accessibility/AccessibilityNodeInfo;
    ...
    :cond_3
    iget-object v3, p1, Ld0/h;->a:Landroid/view/accessibility/AccessibilityNodeInfo;
...
.method public g()Ljava/util/List;
    ...
    new-instance v4, Ld0/h$a;

    invoke-direct {v4, v3}, Ld0/h$a;-><init>(Ljava/lang/Object;)V
...
.method public j0(Ljava/lang/Object;)V
    ...
    iget-object p1, p1, Ld0/h$e;->a:Ljava/lang/Object;
...
.method public k0(Ljava/lang/Object;)V
    ...
    :cond_0
    check-cast p1, Ld0/h$f;

    iget-object p1, p1, Ld0/h$f;->a:Ljava/lang/Object;
...
.method public m(Landroid/graphics/Rect;)V
    ...
    invoke-static {p0, p1}, Ld0/h$d;->b(Landroid/view/accessibility/AccessibilityNodeInfo;Landroid/graphics/Rect;)V
...
.method public q()Ljava/lang/CharSequence;
    ...
    invoke-static {p0}, Ld0/h$d;->c(Landroid/view/accessibility/AccessibilityNodeInfo;)Ljava/lang/CharSequence;
...
.method public toString()Ljava/lang/String;
    ...
    invoke-virtual {p0, v1}, Ld0/h;->k(Landroid/graphics/Rect;)V
    ...
    invoke-virtual {p0, v1}, Ld0/h;->l(Landroid/graphics/Rect;)V
    ...
    invoke-virtual {p0, v1}, Ld0/h;->m(Landroid/graphics/Rect;)V
    ...
    invoke-virtual {p0}, Ld0/h;->v()Ljava/lang/CharSequence;
    ...
    invoke-virtual {p0}, Ld0/h;->o()Ljava/lang/CharSequence;
    ...
    invoke-virtual {p0}, Ld0/h;->x()Ljava/lang/CharSequence;
    ...
    invoke-virtual {p0}, Ld0/h;->s()Ljava/lang/CharSequence;
    ...
    invoke-virtual {p0}, Ld0/h;->w()Ljava/lang/CharSequence;
    ...
    invoke-virtual {p0}, Ld0/h;->r()Ljava/lang/CharSequence;
    ...
    invoke-virtual {p0}, Ld0/h;->y()Ljava/lang/CharSequence;
    ...
    invoke-virtual {p0}, Ld0/h;->z()Ljava/lang/String;
    ...
    invoke-virtual {p0}, Ld0/h;->q()Ljava/lang/CharSequence;
    ...
    invoke-virtual {p0}, Ld0/h;->g()Ljava/util/List;
    ...
    invoke-virtual {v2}, Ld0/h$a;->b()I

    move-result v3

    invoke-static {v3}, Ld0/h;->h(I)Ljava/lang/String;
...
.method public w()Ljava/lang/CharSequence;
    ...
    invoke-static {p0}, Ld0/h$b;->a(Landroid/view/accessibility/AccessibilityNodeInfo;)Ljava/lang/CharSequence;
...
.method public x()Ljava/lang/CharSequence;
    ...
    invoke-direct {p0, v1}, Ld0/h;->f(Ljava/lang/String;)Ljava/util/List;

    move-result-object v1

    const-string v2, "androidx.view.accessibility.AccessibilityNodeInfoCompat.SPANS_FLAGS_KEY"

    invoke-direct {p0, v2}, Ld0/h;->f(Ljava/lang/String;)Ljava/util/List;

    move-result-object v2

    const-string v3, "androidx.view.accessibility.AccessibilityNodeInfoCompat.SPANS_ID_KEY"

    invoke-direct {p0, v3}, Ld0/h;->f(Ljava/lang/String;)Ljava/util/List;

    move-result-object v3

    new-instance v4, Landroid/text/SpannableString;

    iget-object v5, p0, Ld0/h;->a:Landroid/view/accessibility/AccessibilityNodeInfo;

    invoke-virtual {v5}, Landroid/view/accessibility/AccessibilityNodeInfo;->getText()Ljava/lang/CharSequence;

    move-result-object v5

    iget-object v6, p0, Ld0/h;->a:Landroid/view/accessibility/AccessibilityNodeInfo;
    ...
    invoke-direct {v5, v6, p0, v8}, Ld0/a;-><init>(ILd0/h;I)V
...
.method public z()Ljava/lang/String;
    ...
    invoke-static {p0}, Ld0/h$c;->a(Landroid/view/accessibility/AccessibilityNodeInfo;)Ljava/lang/String;
...
.method public z0(Ld0/h$g;)V
    .locals 0

    iget-object p0, p0, Ld0/h;->a:Landroid/view/accessibility/AccessibilityNodeInfo;

    iget-object p1, p1, Ld0/h$g;->a:Ljava/lang/Object;
