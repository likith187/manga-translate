...
.method constructor <init>(Li2/c;Landroidx/room/h;)V
    ...
    iput-object p1, p0, Li2/c$c;->d:Li2/c;
...
.method public d()Ljava/lang/String;
    ...
    const-string p0, "UPDATE OR REPLACE `conversationHistory` SET `conversationId` = ?,`fromText` = ?,`toText` = ?,`fromLanguage` = ?,`toLanguage` = ?,`timestamp` = ?,`state` = ?,`isLeft` = ?,`expandField1` = ?,`expandField2` = ?,`expandField3` = ? WHERE `conversationId` = ?"
...
.method public bridge synthetic g(Ls0/f;Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1, p2}, Li2/c$c;->j(Ls0/f;Lcom/coloros/translate/repository/local/Conversation;)V
