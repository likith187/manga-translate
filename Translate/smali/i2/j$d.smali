...
.method constructor <init>(Li2/j;Landroidx/room/h;)V
    ...
    iput-object p1, p0, Li2/j$d;->d:Li2/j;
...
.method public d()Ljava/lang/String;
    ...
    const-string p0, "UPDATE OR ABORT `text_history` SET `oriContent` = ?,`oriLanguageCode` = ?,`resultContent` = ?,`resultLanguageCode` = ?,`timestamp` = ?,`state` = ?,`expandField1` = ?,`expandField2` = ?,`expandField3` = ?,`globalId` = ?,`type` = ?,`updateTimestamp` = ?,`id` = ? WHERE `id` = ?"
...
.method public bridge synthetic g(Ls0/f;Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1, p2}, Li2/j$d;->j(Ls0/f;Lcom/coloros/translate/repository/local/TextHistory;)V
