...
.field private final fontCallback:Li4/f;

.field private textAppearance:Li4/d;
...
.method public constructor <init>(Lcom/google/android/material/internal/TextDrawableHelper$TextDrawableDelegate;)V
    ...
    iput-object v0, p0, Lcom/google/android/material/internal/TextDrawableHelper;->fontCallback:Li4/f;
...
# virtual methods
.method public getTextAppearance()Li4/d;
    .locals 0

    iget-object p0, p0, Lcom/google/android/material/internal/TextDrawableHelper;->textAppearance:Li4/d;
...
.method public setTextAppearance(Li4/d;Landroid/content/Context;)V
    .locals 2

    iget-object v0, p0, Lcom/google/android/material/internal/TextDrawableHelper;->textAppearance:Li4/d;

    if-eq v0, p1, :cond_2

    iput-object p1, p0, Lcom/google/android/material/internal/TextDrawableHelper;->textAppearance:Li4/d;

    if-eqz p1, :cond_1

    iget-object v0, p0, Lcom/google/android/material/internal/TextDrawableHelper;->textPaint:Landroid/text/TextPaint;

    iget-object v1, p0, Lcom/google/android/material/internal/TextDrawableHelper;->fontCallback:Li4/f;

    invoke-virtual {p1, p2, v0, v1}, Li4/d;->o(Landroid/content/Context;Landroid/text/TextPaint;Li4/f;)V
    ...
    invoke-virtual {p1, p2, v0, v1}, Li4/d;->n(Landroid/content/Context;Landroid/text/TextPaint;Li4/f;)V
...
.method public updateTextPaintDrawState(Landroid/content/Context;)V
    ...
    iget-object p0, p0, Lcom/google/android/material/internal/TextDrawableHelper;->fontCallback:Li4/f;

    invoke-virtual {v0, p1, v1, p0}, Li4/d;->n(Landroid/content/Context;Landroid/text/TextPaint;Li4/f;)V
