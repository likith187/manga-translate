...
.method private initBackground(Landroid/content/Context;)V
    ...
    invoke-virtual {v1, p1}, Lcom/google/android/material/shape/i;->initializeElevationOverlay(Landroid/content/Context;)V

    invoke-static {p0}, Landroidx/core/view/m0;->r(Landroid/view/View;)F

    move-result p1

    invoke-virtual {v1, p1}, Lcom/google/android/material/shape/i;->setElevation(F)V

    invoke-static {p0, v1}, Landroidx/core/view/m0;->n0(Landroid/view/View;Landroid/graphics/drawable/Drawable;)V
...
.method public clearNavigationIconTint()V
    ...
    invoke-static {v2, v0}, Lv/a;->o(Landroid/graphics/drawable/Drawable;Landroid/content/res/ColorStateList;)V
