...
.method public j(Landroid/app/Activity;IILandroid/content/DialogInterface$OnCancelListener;)Landroid/app/Dialog;
    ...
    invoke-virtual/range {v1 .. v6}, Lcom/google/android/gms/common/a;->o(Landroid/content/Context;ILcom/google/android/gms/common/internal/w;Landroid/content/DialogInterface$OnCancelListener;Landroid/content/DialogInterface$OnClickListener;)Landroid/app/Dialog;
...
.method final o(Landroid/content/Context;ILcom/google/android/gms/common/internal/w;Landroid/content/DialogInterface$OnCancelListener;Landroid/content/DialogInterface$OnClickListener;)Landroid/app/Dialog;
    .locals 4
...
.method public final p(Landroid/app/Activity;Landroid/content/DialogInterface$OnCancelListener;)Landroid/app/Dialog;
    ...
    invoke-static {p1, v0}, Lcom/google/android/gms/common/internal/t;->c(Landroid/content/Context;I)Ljava/lang/String;
...
.method public final q(Landroid/content/Context;Lcom/google/android/gms/common/api/internal/d0;)Lcom/google/android/gms/common/api/internal/zabx;
    .locals 2
    ...
    invoke-static {p1, v1, v0}, Lt3/g;->k(Landroid/content/Context;Landroid/content/BroadcastReceiver;Landroid/content/IntentFilter;)Landroid/content/Intent;
...
.method final r(Landroid/app/Activity;Landroid/app/Dialog;Ljava/lang/String;Landroid/content/DialogInterface$OnCancelListener;)V
    ...
    invoke-static {p2, p4}, Ll3/a;->n(Landroid/app/Dialog;Landroid/content/DialogInterface$OnCancelListener;)Ll3/a;

    move-result-object p1

    invoke-virtual {p1, p0, p3}, Ll3/a;->show(Landroidx/fragment/app/FragmentManager;Ljava/lang/String;)V
...
.method final s(Landroid/content/Context;ILjava/lang/String;Landroid/app/PendingIntent;)V
    ...
    invoke-virtual {v3, v4}, Landroidx/core/app/h$d;->l(Z)Landroidx/core/app/h$d;
    ...
    invoke-virtual {v3, p3}, Landroidx/core/app/h$d;->j(Ljava/lang/CharSequence;)Landroidx/core/app/h$d;
    ...
    invoke-virtual {p3, v3}, Landroidx/core/app/h$d;->p(Landroidx/core/app/h$e;)Landroidx/core/app/h$d;

    move-result-object p3

    invoke-static {p1}, Lr3/f;->b(Landroid/content/Context;)Z
    ...
    invoke-virtual {p3, v0}, Landroidx/core/app/h$d;->o(I)Landroidx/core/app/h$d;

    move-result-object v0

    invoke-virtual {v0, v5}, Landroidx/core/app/h$d;->m(I)Landroidx/core/app/h$d;

    invoke-static {p1}, Lr3/f;->c(Landroid/content/Context;)Z
    ...
    :cond_3
    invoke-virtual {p3, p4}, Landroidx/core/app/h$d;->h(Landroid/app/PendingIntent;)Landroidx/core/app/h$d;
    ...
    invoke-virtual {p3, v3}, Landroidx/core/app/h$d;->o(I)Landroidx/core/app/h$d;
    ...
    invoke-virtual {v3, v1}, Landroidx/core/app/h$d;->q(Ljava/lang/CharSequence;)Landroidx/core/app/h$d;
    ...
    invoke-virtual {v1, v6, v7}, Landroidx/core/app/h$d;->r(J)Landroidx/core/app/h$d;

    move-result-object v1

    invoke-virtual {v1, p4}, Landroidx/core/app/h$d;->h(Landroid/app/PendingIntent;)Landroidx/core/app/h$d;

    move-result-object p4

    invoke-virtual {p4, v0}, Landroidx/core/app/h$d;->i(Ljava/lang/CharSequence;)Landroidx/core/app/h$d;

    :goto_0
    invoke-static {}, Lr3/j;->f()Z
    ...
    invoke-static {p4}, Lcom/google/android/gms/common/internal/k;->j(Z)V
    ...
    :try_start_0
    iget-object p0, p0, Lcom/google/android/gms/common/a;->c:Ljava/lang/String;
    ...
    :cond_7
    :goto_1
    invoke-virtual {p3, p0}, Landroidx/core/app/h$d;->g(Ljava/lang/String;)Landroidx/core/app/h$d;
    ...
    :cond_8
    sget-object p1, Lcom/google/android/gms/common/d;->b:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method public final u(Landroid/app/Activity;Lcom/google/android/gms/common/api/internal/g;IILandroid/content/DialogInterface$OnCancelListener;)Z
    .locals 7
    ...
    invoke-static {p2, p4, v0}, Lcom/google/android/gms/common/internal/w;->c(Lcom/google/android/gms/common/api/internal/g;Landroid/content/Intent;I)Lcom/google/android/gms/common/internal/w;
...
.method public final v(Landroid/content/Context;Lcom/google/android/gms/common/ConnectionResult;I)Z
    ...
    invoke-static {p1}, Ls3/a;->a(Landroid/content/Context;)Z
